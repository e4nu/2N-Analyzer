//
// replaces - splines_plot1.cpp
// COMMAND4ROOT: root -b -q plotter_2x2.cpp
//
...
//    std::string graphTitle4 = "#font[12]{#phi_{l}} (All Interactions, 2p)";
    std::string graphTitle1 = "#theta_{l} (All Interactions, 1n1p)";
    std::string graphTitle2 = "#theta_{l} (All Interactions, 2p)";
...
//    std::string graphTitle4 = "#font[12]{#phi_{l}} of Outgoing Lepton (All Interactions, 2p)";
    ...
    TGraph *graph1 = (TGraph *) fileinput->Get("#theta_{l} det sim (1n1p)");
    TGraph *graph2 = (TGraph *) fileinput->Get("#theta_{l} det sim (2p)");
...
//    graph4->GetYaxis()->CenterTitle(centerXtitle);
    ...
    c->SaveAs("Angular Comparison.png");
    c->Clear();
