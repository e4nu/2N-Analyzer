...
string ConfigeTopDir(const char *filename, const std::string &costumTopDir)
{
...
void SetAMapsRootFiles(const char *filename, std::string &TL_root_file_prefix, std::string &Reco_root_file_prefix, std::string &Ratio_root_file_prefix, std::string &cPart_Sep_AMaps_root_file_prefix)
{
    std::string FileName = filename;
    std::string BeamE;

    if (findSubstring(FileName, "2070MeV"))
    {
        BeamE = "2070MeV";
    }
    else if (findSubstring(FileName, "4029MeV"))
    {
        BeamE = "4029MeV";
    }
    else if (findSubstring(FileName, "5986MeV"))
    {
        BeamE = "5986MeV";
    }
    ...
    if (findSubstring(FileName, "Uniform"))
    {
        if (findSubstring(FileName, "Uniform_1e"))
        {
            TL_root_file_prefix = "01_AMap_TL_-_Uniform_1e_sample_" + BeamE + ".root";
            Reco_root_file_prefix = "02_AMap_Reco_-_Uniform_1e_sample_" + BeamE + ".root";
            Ratio_root_file_prefix = "03_AMap_Ratio_-_Uniform_1e_sample_" + BeamE + ".root";
            cPart_Sep_AMaps_root_file_prefix = "04_cPart_Sep_AMaps_-_Uniform_1e_sample_" + BeamE + ".root";
        }
        else if (findSubstring(FileName, "Uniform_ep"))
        {
            TL_root_file_prefix = "01_AMap_TL_-_Uniform_ep_sample_" + BeamE + ".root";
            Reco_root_file_prefix = "02_AMap_Reco_-_Uniform_ep_sample_" + BeamE + ".root";
            Ratio_root_file_prefix = "03_AMap_Ratio_-_Uniform_ep_sample_" + BeamE + ".root";
            cPart_Sep_AMaps_root_file_prefix = "04_cPart_Sep_AMaps_-_Uniform_ep_sample_" + BeamE + ".root";
        }
        else if (findSubstring(FileName, "Uniform_en"))
        {
            TL_root_file_prefix = "01_AMap_TL_-_Uniform_en_sample_" + BeamE + ".root";
            Reco_root_file_prefix = "02_AMap_Reco_-_Uniform_en_sample_" + BeamE + ".root";
            Ratio_root_file_prefix = "03_AMap_Ratio_-_Uniform_en_sample_" + BeamE + ".root";
            cPart_Sep_AMaps_root_file_prefix = "04_cPart_Sep_AMaps_-_Uniform_en_sample_" + BeamE + ".root";
        }
    }
    else
    {
...
void SetAMapsRootFiles(const char *filename, std::string &TL_root_file_prefix, std::string &Reco_root_file_prefix, std::string &Ratio_root_file_prefix, std::string &cPart_Sep_AMaps_root_file_prefix, std::string &Finalized_AMaps_root_file_prefix)
{
    std::string FileName = filename;
    std::string BeamE;
    ...
    if (findSubstring(FileName, "Uniform"))
    {
        if (findSubstring(FileName, "Uniform_1e"))
        {
            ...
            Ratio_root_file_prefix = "03_AMap_Ratio_-_Uniform_1e_sample_" + BeamE + ".root";
            cPart_Sep_AMaps_root_file_prefix = "04_cPart_Sep_AMaps_-_Uniform_1e_sample_" + BeamE + ".root";
            Finalized_AMaps_root_file_prefix = "05_AMaps_-_Uniform_1e_sample_" + BeamE + ".root";
        }
        else if (findSubstring(FileName, "Uniform_ep"))
        {
            TL_root_file_prefix = "01_AMap_TL_-_Uniform_ep_sample_" + BeamE + ".root";
            ...
            Ratio_root_file_prefix = "03_AMap_Ratio_-_Uniform_ep_sample_" + BeamE + ".root";
            cPart_Sep_AMaps_root_file_prefix = "04_cPart_Sep_AMaps_-_Uniform_ep_sample_" + BeamE + ".root";
            Finalized_AMaps_root_file_prefix = "05_AMaps_-_Uniform_ep_sample_" + BeamE + ".root";
        }
        else if (findSubstring(FileName, "Uniform_en"))
        {
            TL_root_file_prefix = "01_AMap_TL_-_Uniform_en_sample_" + BeamE + ".root";
            ...
            Ratio_root_file_prefix = "03_AMap_Ratio_-_Uniform_en_sample_" + BeamE + ".root";
            cPart_Sep_AMaps_root_file_prefix = "04_cPart_Sep_AMaps_-_Uniform_en_sample_" + BeamE + ".root";
            Finalized_AMaps_root_file_prefix = "05_AMaps_-_Uniform_en_sample_" + BeamE + ".root";
        }
    }
    else
    {
...
int countHistograms(const char *filename, const std::string &ParticleNameShort1, const int &numHistograms, const bool &Sep_plots = false, const std::string &OutputPath = "",
                    const int Num_of_hist_rows = 3, const int Num_of_hist_col = 3)
{
    ...
    if (ParticleNameShort1 == "e" && findSubstring(filename, "Uniform_1e"))
    {
            ...
            if (findSubstring(Histogram2DTempName, ParticleNameShort2))
            {
                ...
                if (Sep_plots)
                {
                    ...
                    if (findSubstring(Histogram2DTempName, "TL ") && !findSubstring(Histogram2DTempName, "/TL"))
                    {
                        ...
                        // Histograms2D.push_back(Histogram2DTemp);
                        Sep_canv->Clear();
                    }
                    else if (findSubstring(Histogram2DTempName, "Reco "))
                    {
        ...
        CombineHistogramsToGif(Sep_canv, Histograms2D, 1000 * 1.5, 750 * 1.5, OutputPath, SliceVariant0 + "_" + ParticleNameShort1 + "_GIF.gif", SliceVariant0, "50", "0");
    ...
    else if (ParticleNameShort1 == "n" && findSubstring(filename, "Uniform_en"))
    {
        ...
        {
            std::std::cerr << "Error: Could not open file: " << FileName << std::endl, exit(0);
        }
        if (!TL_Histogram2D)
        {
...
void AMapsPlotter(const std::string &InputPath = "", const bool &Sep_plots = false, const std::string &OutputPath = "")
{
    ...
    std::string TL_root_file_prefix, Reco_root_file_prefix, Ratio_root_file_prefix, cPart_Sep_AMaps_root_file_prefix;
    ...
    int NumOf1eSlices = countHistograms((PlotsPath + TL_root_file_prefix).c_str(), "e", 30, Sep_plots, OutputPath, 3, 4);
    plotHistograms((PlotsPath + TL_root_file_prefix).c_str(), "e", NumOf1eSlices, Sep_plots, OutputPath, 3, 4);
    plotHistograms((PlotsPath + Reco_root_file_prefix).c_str(), "e", NumOf1eSlices, Sep_plots, OutputPath, 3, 4);
    plotHistograms((PlotsPath + Ratio_root_file_prefix).c_str(), "e", NumOf1eSlices, Sep_plots, OutputPath, 3, 4);
    plotHistograms((PlotsPath + cPart_Sep_AMaps_root_file_prefix).c_str(), "e", NumOf1eSlices, Sep_plots, OutputPath, 3, 4);

    int NumOfepSlices = countHistograms((PlotsPath + TL_root_file_prefix).c_str(), "p", NumOfepSlices, Sep_plots, OutputPath, 3, 4);
    plotHistograms((PlotsPath + TL_root_file_prefix).c_str(), "p", NumOfepSlices, Sep_plots, OutputPath, 3, 4);
    plotHistograms((PlotsPath + Reco_root_file_prefix).c_str(), "p", NumOfepSlices, Sep_plots, OutputPath, 3, 4);
    plotHistograms((PlotsPath + Ratio_root_file_prefix).c_str(), "p", NumOfepSlices, Sep_plots, OutputPath, 3, 4);
    plotHistograms((PlotsPath + cPart_Sep_AMaps_root_file_prefix).c_str(), "p", NumOfepSlices, Sep_plots, OutputPath, 3, 4);
