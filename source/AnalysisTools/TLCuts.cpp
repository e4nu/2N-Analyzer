...
TLCuts::TLCuts(const std::string &SampleName, bool calculate_truth_level, bool Enable_photons_FD, bool apply_nucleon_cuts, TH2D *Electron_AMap, TH2D *Proton_AMap, TH2D *Neutron_AMap,
               const DSCuts &ThetaFD, double Theta_ulim_FD, double Theta_llim_FD, const DSCuts &ThetaCD, double Theta_ulim_CD, double Theta_llim_CD, double Phi_llim,
               double Phi_ulim, const DSCuts &TL_e_mom_cuts, const DSCuts &TL_n_mom_cuts, const DSCuts &TL_p_mom_cuts, const DSCuts &TL_pip_mom_cuts, const DSCuts &TL_pim_mom_cuts,
