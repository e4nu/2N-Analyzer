...
#pragma region /* Creating plots directories */
    ...
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/E_cal_restorations").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/E_cal_restorations/Other").c_str());
    // TODO: IPS plots - these plots are for IPS poster. Rename them to fit the code.
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/E_cal_restorations/All_Int_Stack_IPS").c_str());

    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_histograms").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_histograms/El_histograms").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_histograms/El_VS_theta_l").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_histograms/El_VS_theta_l/all_interactions").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_histograms/El_VS_theta_l/QEL_only").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_histograms/El_VS_theta_l/MEC_only").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_histograms/El_VS_theta_l/RES_only").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_histograms/El_VS_theta_l/DIS_only").c_str());

    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_transfer_histograms").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_transfer_histograms/Energy_transfer_histograms_all_interactions").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_transfer_histograms/Energy_transfer_histograms_DIS_only").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_transfer_histograms/Energy_transfer_histograms_MEC_only").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_transfer_histograms/Energy_transfer_histograms_QEL_only").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_transfer_histograms/Energy_transfer_histograms_RES_only").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_transfer_histograms/Energy_transfer_VS_q3").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_transfer_histograms/Inclusive_plots").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_transfer_histograms/ET_All_Ang_2p").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/Energy_transfer_histograms/ET_All_Ang_1n1p").c_str());

    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/MicroBooNE_plots").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/MicroBooNE_plots/gamma_lab").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/MicroBooNE_plots/gamma_lab/all_interactions").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/MicroBooNE_plots/gamma_lab/DIS_only").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/MicroBooNE_plots/gamma_lab/MEC_only").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/MicroBooNE_plots/gamma_lab/QEL_only").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/MicroBooNE_plots/gamma_lab/RES_only").c_str());
    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/MicroBooNE_plots/momentum_distributions").c_str());

    system(("mkdir -p " + path_definitions::PathDefinitions.WorkingDirectory + "plots/momentum_histograms").c_str());
...
#pragma region /* FSI indicator */
    ...
    std::cout << "File input:\t" << InputHipoFiles << "\n";
...
#pragma endregion
    ...
    // Angular histogram limits
    double theta_lp_upper_lim_2p = 0, theta_lp_lower_lim_2p = 0;
    double theta_p1_upper_lim_2p = 0, theta_p1_lower_lim_2p = 0;
    double theta_p2_upper_lim_2p = 0, theta_p2_lower_lim_2p = 0;
    double dtheta_upper_lim_2p = 0, dtheta_lower_lim_2p = 0;
    double theta_lp_upper_lim_1n1p = 0, theta_lp_lower_lim_1n1p = 0;
    double theta_p_upper_lim_1n1p = 0, theta_p_lower_lim_1n1p = 0;
    double theta_n_upper_lim_1n1p = 0, theta_n_lower_lim_1n1p = 0;
    double dtheta_upper_lim_1n1p = 0, dtheta_lower_lim_1n1p = 0;
    double phi_lp_upper_lim_2p = 0, phi_lp_lower_lim_2p = 0;
    double phi_p1_upper_lim_2p = 0, phi_p1_lower_lim_2p = 0;
    double phi_p2_upper_lim_2p = 0, phi_p2_lower_lim_2p = 0;
    double dphi_upper_lim_2p = 0, dphi_lower_lim_2p = 0;
    double phi_lp_upper_lim_1n1p = 0, phi_lp_lower_lim_1n1p = 0;
    double phi_p_upper_lim_1n1p = 0, phi_p_lower_lim_1n1p = 0;
    double phi_n_upper_lim_1n1p = 0, phi_n_lower_lim_1n1p = 0;
    double dphi_upper_lim_1n1p = 0, dphi_lower_lim_1n1p = 0;
    double Gamma_Lab_upper_lim = 0, Gamma_Lab_lower_lim = 0;
    double Gamma_mu_p_tot_upper_lim = 0, Gamma_mu_p_tot_lower_lim = 0;
    double Gamma_Lab_weighted_upper_lim = 0, Gamma_Lab_weighted_lower_lim = 0;
    double Gamma_mu_p_tot_weighted_upper_lim = 0, Gamma_mu_p_tot_weighted_lower_lim = 0;
    double Gamma_Lab_noPions_All_Int_upper_lim = 0, Gamma_Lab_noPions_All_Int_lower_lim = 0;
    double Gamma_Lab_noPions_All_Int_weighted_upper_lim = 0, Gamma_Lab_noPions_All_Int_weighted_lower_lim = 0;
    double Gamma_Lab_noPions_QEL_upper_lim = 0, Gamma_Lab_noPions_QEL_lower_lim = 0;
    double Gamma_Lab_noPions_QEL_weighted_upper_lim = 0, Gamma_Lab_noPions_QEL_weighted_lower_lim = 0;
    double Gamma_Lab_noPions_MEC_upper_lim = 0, Gamma_Lab_noPions_MEC_lower_lim = 0;
    double Gamma_Lab_noPions_MEC_weighted_upper_lim = 0, Gamma_Lab_noPions_MEC_weighted_lower_lim = 0;
    double Gamma_Lab_noPions_RES_upper_lim = 0, Gamma_Lab_noPions_RES_lower_lim = 0;
    double Gamma_Lab_noPions_RES_weighted_upper_lim = 0, Gamma_Lab_noPions_RES_weighted_lower_lim = 0;
    double Gamma_Lab_noPions_DIS_upper_lim = 0, Gamma_Lab_noPions_DIS_lower_lim = 0;
    double Gamma_Lab_noPions_DIS_weighted_upper_lim = 0, Gamma_Lab_noPions_DIS_weighted_lower_lim = 0;
    double dP_T_hist_upper_lim = 0, dP_T_hist_lower_lim = 0;
    double dP_T_hist_weighted_upper_lim = 0, dP_T_hist_weighted_lower_lim = 0;
    double P_L_hist_upper_lim = 0, P_L_hist_lower_lim = 0;
    double P_R_hist_upper_lim = 0, P_R_hist_lower_lim = 0;
    double P_lp_hist_upper_lim = 0, P_lp_hist_lower_lim = 0;
    double P_pion_hist_upper_lim = 0, P_pion_hist_lower_lim = 0;
    double E_Trans15_all_inclusive_upper_lim = 0, E_Trans15_all_inclusive_lower_lim = 0;
    double E_Trans15_QEL_inclusive_upper_lim = 0, E_Trans15_QEL_inclusive_lower_lim = 0;
    double E_Trans15_MEC_inclusive_upper_lim = 0, E_Trans15_MEC_inclusive_lower_lim = 0;
    double E_Trans15_RES_inclusive_upper_lim = 0, E_Trans15_RES_inclusive_lower_lim = 0;
    double E_Trans15_DIS_inclusive_upper_lim = 0, E_Trans15_DIS_inclusive_lower_lim = 0;
    double P_L_hist_upper_lim_2p = 0, P_L_hist_lower_lim_2p = 0;
    double P_R_hist_upper_lim_2p = 0, P_R_hist_lower_lim_2p = 0;
    double P_lp_hist_upper_lim_2p = 0, P_lp_hist_lower_lim_2p = 0;
    double P_p_hist_upper_lim_1n1p = 0, P_p_hist_lower_lim_1n1p = 0;
    double P_n_hist_upper_lim_1n1p = 0, P_n_hist_lower_lim_1n1p = 0;
    double P_lp_hist_upper_lim_1n1p = 0, P_lp_hist_lower_lim_1n1p = 0;
    double E_Trans15_DIS_lower_lim_1n1p = 0;
    double E_Trans15_DIS_lower_lim_2p = 0;
    double E_Trans15_DIS_upper_lim_1n1p = 0;
    double E_Trans15_DIS_upper_lim_2p = 0;
    double E_Trans15_MEC_lower_lim_1n1p = 0;
    double E_Trans15_MEC_lower_lim_2p = 0;
    double E_Trans15_MEC_upper_lim_1n1p = 0;
    double E_Trans15_MEC_upper_lim_2p = 0;
    double E_Trans15_QEL_lower_lim_1n1p = 0;
    double E_Trans15_QEL_lower_lim_2p = 0;
    double E_Trans15_QEL_upper_lim_1n1p = 0;
    double E_Trans15_QEL_upper_lim_2p = 0;
    double E_Trans15_RES_lower_lim_1n1p = 0;
    double E_Trans15_RES_lower_lim_2p = 0;
    double E_Trans15_RES_upper_lim_1n1p = 0;
    double E_Trans15_RES_upper_lim_2p = 0;
    double E_Trans15_all_lower_lim_1n1p = 0;
    double E_Trans15_all_lower_lim_2p = 0;
    double E_Trans15_all_upper_lim_1n1p = 0;
    double E_Trans15_all_upper_lim_2p = 0;
    double E_Trans45_DIS_lower_lim_1n1p = 0;
    double E_Trans45_DIS_lower_lim_2p = 0;
    double E_Trans45_DIS_upper_lim_1n1p = 0;
    double E_Trans45_DIS_upper_lim_2p = 0;
    double E_Trans45_MEC_lower_lim_1n1p = 0;
    double E_Trans45_MEC_lower_lim_2p = 0;
    double E_Trans45_MEC_upper_lim_1n1p = 0;
    double E_Trans45_MEC_upper_lim_2p = 0;
    double E_Trans45_QEL_lower_lim_1n1p = 0;
    double E_Trans45_QEL_lower_lim_2p = 0;
    double E_Trans45_QEL_upper_lim_1n1p = 0;
    double E_Trans45_QEL_upper_lim_2p = 0;
    double E_Trans45_RES_lower_lim_1n1p = 0;
    double E_Trans45_RES_lower_lim_2p = 0;
    double E_Trans45_RES_upper_lim_1n1p = 0;
    double E_Trans45_RES_upper_lim_2p = 0;
    double E_Trans45_all_lower_lim_1n1p = 0;
    double E_Trans45_all_lower_lim_2p = 0;
    double E_Trans45_all_upper_lim_1n1p = 0;
    double E_Trans45_all_upper_lim_2p = 0;
    double E_Trans90_DIS_lower_lim_1n1p = 0;
    double E_Trans90_DIS_lower_lim_2p = 0;
    double E_Trans90_DIS_upper_lim_1n1p = 0;
    double E_Trans90_DIS_upper_lim_2p = 0;
    double E_Trans90_MEC_lower_lim_1n1p = 0;
    double E_Trans90_MEC_lower_lim_2p = 0;
    double E_Trans90_MEC_upper_lim_1n1p = 0;
    double E_Trans90_MEC_upper_lim_2p = 0;
    double E_Trans90_QEL_lower_lim_1n1p = 0;
    double E_Trans90_QEL_lower_lim_2p = 0;
    double E_Trans90_QEL_upper_lim_1n1p = 0;
    double E_Trans90_QEL_upper_lim_2p = 0;
    double E_Trans90_RES_lower_lim_1n1p = 0;
    double E_Trans90_RES_lower_lim_2p = 0;
    double E_Trans90_RES_upper_lim_1n1p = 0;
    double E_Trans90_RES_upper_lim_2p = 0;
    double E_Trans90_all_lower_lim_1n1p = 0;
    double E_Trans90_all_lower_lim_2p = 0;
    double E_Trans90_all_upper_lim_1n1p = 0;
    double E_Trans90_all_upper_lim_2p = 0;
    double E_Trans_VS_q3_MEC_lower_lim_x_1n1p = 0;
    double E_Trans_VS_q3_MEC_lower_lim_x_2p = 0;
    double E_Trans_VS_q3_MEC_lower_lim_y_1n1p = 0;
    double E_Trans_VS_q3_MEC_lower_lim_y_2p = 0;
    double E_Trans_VS_q3_MEC_upper_lim_x_1n1p = 0;
    double E_Trans_VS_q3_MEC_upper_lim_x_2p = 0;
    double E_Trans_VS_q3_MEC_upper_lim_y_1n1p = 0;
    double E_Trans_VS_q3_MEC_upper_lim_y_2p = 0;
    double E_Trans_VS_q3_QEL_lower_lim_x_1n1p = 0;
    double E_Trans_VS_q3_QEL_lower_lim_x_2p = 0;
    double E_Trans_VS_q3_QEL_lower_lim_y_1n1p = 0;
    double E_Trans_VS_q3_QEL_lower_lim_y_2p = 0;
    double E_Trans_VS_q3_QEL_upper_lim_x_1n1p = 0;
    double E_Trans_VS_q3_QEL_upper_lim_x_2p = 0;
    double E_Trans_VS_q3_QEL_upper_lim_y_1n1p = 0;
    double E_Trans_VS_q3_QEL_upper_lim_y_2p = 0;
    double E_Trans_VS_q3_all_lower_lim_x_1n1p = 0;
    double E_Trans_VS_q3_all_lower_lim_x_2p = 0;
    double E_Trans_VS_q3_all_lower_lim_y_1n1p = 0;
    double E_Trans_VS_q3_all_lower_lim_y_2p = 0;
    double E_Trans_VS_q3_all_upper_lim_x_1n1p = 0;
    double E_Trans_VS_q3_all_upper_lim_x_2p = 0;
    double E_Trans_VS_q3_all_upper_lim_y_1n1p = 0;
    double E_Trans_VS_q3_all_upper_lim_y_2p = 0;
    double E_Trans_VS_q_MEC_inclusive_lower_lim_x = 0;
    double E_Trans_VS_q_MEC_inclusive_lower_lim_y = 0;
    double E_Trans_VS_q_MEC_inclusive_upper_lim_x = 0;
    double E_Trans_VS_q_MEC_inclusive_upper_lim_y = 0;
    double E_Trans_VS_q_QEL_inclusive_lower_lim_x = 0;
    double E_Trans_VS_q_QEL_inclusive_lower_lim_y = 0;
    double E_Trans_VS_q_QEL_inclusive_upper_lim_x = 0;
    double E_Trans_VS_q_QEL_inclusive_upper_lim_y = 0;
    double E_Trans_VS_q_all_inclusive_lower_lim_x = 0;
    double E_Trans_VS_q_all_inclusive_lower_lim_y = 0;
    double E_Trans_VS_q_all_inclusive_upper_lim_x = 0;
    double E_Trans_VS_q_all_inclusive_upper_lim_y = 0;
    double E_Trans_all_ang_all_int_lower_lim_1n1p = 0;
    double E_Trans_all_ang_all_int_lower_lim_2p = 0;
    double E_Trans_all_ang_all_int_upper_lim_1n1p = 0;
    double E_Trans_all_ang_all_int_upper_lim_2p = 0;
    double E_cal_DIS_lower_lim_1n1p = 0;
    double E_cal_DIS_lower_lim_2p = 0;
    double E_cal_DIS_lower_lim_range = 0;
    double E_cal_DIS_upper_lim_1n1p = 0;
    double E_cal_DIS_upper_lim_2p = 0;
    double E_cal_DIS_upper_lim_range = 0;
    double E_cal_MEC_lower_lim_1n1p = 0;
    double E_cal_MEC_lower_lim_2p = 0;
    double E_cal_MEC_lower_lim_range = 0;
    double E_cal_MEC_upper_lim_1n1p = 0;
    double E_cal_MEC_upper_lim_2p = 0;
    double E_cal_MEC_upper_lim_range = 0;
    double E_cal_QEL_lower_lim_1n1p = 0;
    double E_cal_QEL_lower_lim_2p = 0;
    double E_cal_QEL_lower_lim_range = 0;
    double E_cal_QEL_upper_lim_1n1p = 0;
    double E_cal_QEL_upper_lim_2p = 0;
    double E_cal_QEL_upper_lim_range = 0;
    double E_cal_RES_lower_lim_1n1p = 0;
    double E_cal_RES_lower_lim_2p = 0;
    double E_cal_RES_lower_lim_range = 0;
    double E_cal_RES_upper_lim_1n1p = 0;
    double E_cal_RES_upper_lim_2p = 0;
    double E_cal_RES_upper_lim_range = 0;
    double fsEl_DIS_lower_lim_1n1p = 0;
    double fsEl_DIS_lower_lim_2p = 0;
    double fsEl_DIS_upper_lim_1n1p = 0;
    double fsEl_DIS_upper_lim_2p = 0;
    double fsEl_MEC_lower_lim_1n1p = 0;
    double fsEl_MEC_lower_lim_2p = 0;
    double fsEl_MEC_upper_lim_1n1p = 0;
    double fsEl_MEC_upper_lim_2p = 0;
    double fsEl_QEL_lower_lim_1n1p = 0;
    double fsEl_QEL_lower_lim_2p = 0;
    double fsEl_QEL_upper_lim_1n1p = 0;
    double fsEl_QEL_upper_lim_2p = 0;
    double fsEl_RES_lower_lim_1n1p = 0;
    double fsEl_RES_lower_lim_2p = 0;
    double fsEl_RES_upper_lim_1n1p = 0;
    double fsEl_RES_upper_lim_2p = 0;
    double fsEl_VS_theta_lp_lower_lim_1n1p_x = 0;
    double fsEl_VS_theta_lp_lower_lim_1n1p_y = 0;
    double fsEl_VS_theta_lp_lower_lim_2p_x = 0;
    double fsEl_VS_theta_lp_lower_lim_2p_y = 0;
    double fsEl_VS_theta_lp_upper_lim_1n1p_x = 0;
    double fsEl_VS_theta_lp_upper_lim_1n1p_y = 0;
    double fsEl_VS_theta_lp_upper_lim_2p_x = 0;
    double fsEl_VS_theta_lp_upper_lim_2p_y = 0;
    double fsEl_lower_lim_1n1p = 0;
    double fsEl_lower_lim_2p = 0;
    double fsEl_upper_lim_1n1p = 0;
    double fsEl_upper_lim_2p = 0;
...
#pragma region /* Saving setup to log file */
    ...
    myLogFile.open("" + path_definitions::PathDefinitions.WorkingDirectory + "plots/Run_log.txt");
...
#pragma region /* Theta histograms */
    ...
    TH1D* theta_lp_1n1p = new TH1D("#theta_{l} (1n1p)", ";#theta_{l} [Deg];", 100, theta_lp_lower_lim_1n1p, theta_lp_upper_lim_1n1p);
...
#pragma region /* Phi histograms */
    ...
    TH1D* phi_lp_1n1p = new TH1D("#phi_{l} (1n1p)", ";#phi_{l} [Deg];", 100, phi_lp_lower_lim_1n1p, phi_lp_upper_lim_1n1p);
...
#pragma region /* E_cal restoration histograms - old plots */
    ...
    TH1D* hEcal_RES_2p = new TH1D("Truth-level E_{cal} (RES only, 2p)", "Truth-level E_{cal} (RES only, 2p);E_{cal} = E_{l} + T_{p_{1}} + T_{p_{2}} [GeV] [GeV]", 100, E_cal_RES_lower_lim_2p,
...
#pragma endregion
    ...
    std::string HistoListPDFFileName = path_definitions::PathDefinitions.plots_path + "/" + file_name + ".pdf";
...
#pragma endregion
    ...
    std::string Histogram_OutPDF_fileName = path_definitions::PathDefinitions.plots_path + "/Out" + plots_TFile_FileType;
...
#pragma region /* dTheta histogram (2p) */
        histPlotter1D(c1, dtheta_2p, normalized_dtheta_2p_plots, true, 1., "#gamma = #theta_{p1} - #theta_{p2} of Scattered Protons", "All Interactions", 0.06, 0.0425, 0.0425, plots,
                      HistoList, 2, false, true, ThetaStack, "gamma_of_protons", "plots/theta_histograms/", "2p", kBlue, true, false, true);
#pragma endregion
...
#pragma region /* Energy transfer (Ev-El) for every theta_{l} (2p) */
        ...
        histPlotter1D(c1, E_Trans_all_ang_all_int_2p, normalized_E_Trans_all_ang_all_int_plots, false, 1., "#omega for every #theta_{l'}", "All Interactions", 0.06, 0.0425, 0.0425, plots,
                      HistoList, 3, false, true, sE_Trans_all_ang_2p, "Energy_transfer_Ev-El_all_Deg_all_interactions",
...
#pragma endregion
        ...
        //        #pragma region /* Energy transfer around 15 deg stack (1n1p only) */
...
#pragma region /* E_cal_MEC restoration (stack of 2p and 1n1p) */
        ...
        auto E_cal_MEC_Stack_1n1p_and_2p_legend = new TLegend(0.75, 0.775, 0.875, 0.9);
...
#pragma region /* E_cal_MEC restoration (stack of 2p and 2n) */
        ...
        auto E_cal_MEC_Stack_2p_and_2n_legend = new TLegend(0.75, 0.775, 0.875, 0.9);
