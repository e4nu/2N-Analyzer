...
//
// The constructor runs a sequence of \CONFIG_DIR + "*\" methods that parse `RecoSamplePath` and set member variables.
      ...
      InputFilesGlobal("/" + RecoSamplePath + "/" + ReconHipoDir + "/" + HipoFilesPrefix)  // Full glob pattern for input files, e.g. "/path/to/samples/*hipo"
{
    ...
    basic_tools::ExitWithError("ExperimentParameters::ExperimentParameters", __FILE__, __LINE__,
