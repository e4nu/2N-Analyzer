...
bool NeutronCD_CutVeto(const std::unique_ptr<clas12::clas12reader>& c12, int index, int cnd_hits, int cnd_hit_layer, int cnd_hit_sector, int cnd_hit_energy, int ctof_hits,
                       int ctof_hit_component, int ctof_hit_energy) {
    auto allParticles = c12->getDetParticles();
