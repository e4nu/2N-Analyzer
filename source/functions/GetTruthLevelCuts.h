...
void GetTruthLevelCuts(const string &SampleName, bool calculate_truth_level, bool Enable_FD_photons, bool apply_nucleon_cuts, TH2D *Electron_AMap, TH2D *Proton_AMap, TH2D *Neutron_AMap,
                       ...
                       double Phi_lboundary, double Phi_uboundary, const DSCuts &TL_e_mom_cuts, const DSCuts &TL_n_mom_cuts, const DSCuts &TL_p_mom_cuts, const DSCuts &TL_pip_mom_cuts,
