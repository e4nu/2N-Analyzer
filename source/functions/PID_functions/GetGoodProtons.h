...
vector<int> GetGoodProtons(bool apply_nucleon_cuts, vector<region_part_ptr> &protons, const vector<int> &IDProtons_ind, DSCuts &Theta_p1_cuts_2p, DSCuts &Theta_p2_cuts_2p,
...
void GPMonitoring(bool GoodProtonsMonitorPlots, vector<region_part_ptr> &protons, const vector<int> &IDProtons_ind, const vector<int> &Protons_ind, DSCuts &Theta_p1_cuts_2p,
                  DSCuts &Theta_p2_cuts_2p, DSCuts &dphi_p1_p2_2p, double Weight) {
    if (GoodProtonsMonitorPlots) {
        for (int i = 0; i < IDProtons_ind.size(); i++) {
