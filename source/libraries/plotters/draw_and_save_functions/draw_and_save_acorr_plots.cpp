...
#include "libraries/plotters/draw_and_save_functions/draw_and_save_acorr_plots.h"
...
#pragma region /* Setting y axis label */
    ...
    //    std::string ACorrectionYLabel = "#epsilon_{eff} = " + xLabel_REC + "^{rec}" + "/" + xLabel_Truth;#pragma endregion
...
#pragma region /* Setting save directory */
        std::string ACorrectionSaveDir,
        ACorrectionTestSaveDir;
...
#pragma region /* Setting title */
    ...
    //    std::string ACorrectionTitle = ACorrectionParticle + " " + ACorrectionType;#pragma endregion
