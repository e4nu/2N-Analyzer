...
#include "libraries/plotters/draw_and_save_functions/draw_and_save_efficiency_plots.h"
...
#pragma region /* Setting region */
        std::string EfficiencyParticleRegion = "",
                    EfficiencyParticleRegionDir = "";
...
#pragma region /* Setting save directory */
        std::string EfficiencySaveDir,
        EfficiencyTestSaveDir;
...
#pragma region /* Setting title */
    ...
    //    std::string EfficiencyTitle = EfficiencyParticle + " " + EfficiencyType;#pragma endregion
...
#pragma region /* Setting y axis label */
    ...
    //    std::string EfficiencyYLabel = "#epsilon_{eff} = " + xLabel_REC + "/" + xLabel_Truth;#pragma endregion
...
#pragma region /* Setting save name */
    ...
    //    std::string Efficiency_plot_SaveName = EfficiencySaveDir + sNameFlag + "_" + EfficiencyParticle + "_" + EfficiencyType + "_efficiency_" + EfficiencyFS + ".pdf";#pragma endregion
