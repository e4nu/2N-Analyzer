...
#pragma region /* Drawing fit parameters and saving */
            double x_1_Cut_legend = gStyle->GetStatX(),
                   y_1_Cut_legend = gStyle->GetStatY() - 0.2;
...
#pragma region /* Solve deltaP/P for beta in range 0.9<=beta<1 */
            double Beta_Max,
            P_Beta_Max, Beta_Min, P_Beta_Min;
...
#pragma region /* Plot w as function of beta */
    ...
    else { Momentum_cuts.SetUpperCut(beamE); }
}
#pragma endregion
...
#pragma region /* Solve deltaP/P for beta in range 0.9<=beta<1 */
            double Beta_Max_Apprax,
            P_Beta_Max_Apprax, Beta_Min_Apprax, P_Beta_Min_Apprax;
