        ...
        for (int rn_ind = 0; rn_ind < rn_factor_v.size(); rn_ind++) {
            for (int Ebeam_ind = 0; Ebeam_ind < Ebeam_v.size(); Ebeam_ind++) {
                ...
                if (Is2GeV) {
                    ...
                    //     InputFiles = BaseDir + "/2070MeV_ConstPn/OutPut_en/reconhipo/*.hipo";
                    // } else {
                    //     InputFiles = BaseDir + "/2070MeV/OutPut_en/reconhipo/*.hipo";
                    // }
                    ...
                    // if (use_ConstPn_samples) {
                    //     InputFiles = BaseDir + "/4029MeV_ConstPn/OutPut_en/reconhipo/*.hipo";
                    // } else {
                    //     InputFiles = BaseDir + "/4029MeV/OutPut_en/reconhipo/*.hipo";
                    // }
                    ...
                    // if (use_ConstPn_samples) {
                    //     // InputFiles = BaseDir + "/5986MeV_ConstPn_lH2/OutPut_en/reconhipo/*.hipo";
                    //     InputFiles = BaseDir + "/5986MeV_ConstPn/OutPut_en/reconhipo/*.hipo";
                    // } else {
                    //     InputFiles = BaseDir + "/5986MeV/OutPut_en/reconhipo/*.hipo";
                    // }
...
#pragma region /* Electron PID */
                ...
                TH2D* h_Edep_PCAL_VS_EC_AC_1e_cut =
                    new TH2D("Edep_PCAL_VS_EC_AC_1e_cut", "E_{dep}^{PCAL} vs. E_{dep}^{EC} in 1e cut (after cut);E_{dep}^{PCAL} [GeV];E_{dep}^{EC} = E_{dep}^{ECIN} + E_{dep}^{ECOUT} [GeV]",
                             100, 0, 0.2, 100, 0, 0.3);
                HistoList_electron_cuts.push_back(h_Edep_PCAL_VS_EC_AC_1e_cut);

                TH2D* h_SF_VS_P_e_BC_1e_cut = new TH2D("SF_VS_P_e_BC_1e_cut", "Electron sampling fraction vs. P_{e} in 1e cut (before cut);P_{e} [GeV/c];Electron sampling fraction", 100, 0,
                                                       Ebeam * 1.1, 100, 0.16, 0.3);
                HistoList_electron_cuts.push_back(h_SF_VS_P_e_BC_1e_cut);
                TH2D* h_SF_VS_P_e_AC_1e_cut = new TH2D("SF_VS_P_e_AC_1e_cut", "Electron sampling fraction vs. P_{e} in 1e cut (after cut);P_{e} [GeV/c];Electron sampling fraction", 100, 0,
                                                       Ebeam * 1.1, 100, 0.16, 0.3);
                ...
                TH2D* h_E_PCALoP_e_VS_E_PCALoP_e_AC_1e_cut =
                    new TH2D("E_PCALoP_e_VS_E_PCALoP_e_AC", "E_{dep}^{PCAL}/P_{e} vs. E_{dep}^{ECIN}/P_{e} in 1e cut (after cut);E_{dep}^{PCAL}/P_{e};E_{dep}^{ECIN}/P_{e}", 100, 0, 0.3, 100,
                             0, 0.35);
...
#pragma region /* redef */
                ...
                TH2D* h_reco_P_e_VS_P_nFD_redef_1e_cut =
                    new TH2D("reco_P_e_VS_P_nFD_redef_1e_cut", "P^{reco}_{e} vs. P^{reco}_{nFD} in 1e cut (redef);P^{reco}_{e} [GeV/c];P^{reco}_{nFD} [GeV/c]", 100, 0., Ebeam * 2., 100, 0.,
                             Ebeam * 3.);
                HistoList_redef.push_back(h_reco_P_e_VS_P_nFD_redef_1e_cut);
                TH2D* h_reco_theta_nFD_redef_VS_P_nFD_redef_1e_cut =
                    new TH2D("reco_theta_nFD_redef_VS_P_nFD_redef_1e_cut", "#theta^{reco}_{nFD} vs. P^{reco}_{nFD} in 1e cut (redef);#theta^{reco}_{nFD} [#circ];P^{reco}_{nFD} [GeV/c]", 100,
                             0., 50., 100, 0., Ebeam * 3.);
...
#pragma region /* Base histograms (ECALveto) */
                ...
                TH2D* h_reco_theta_e_VS_P_nFD_ECALveto_1e_cut =
                    new TH2D("reco_theta_e_VS_P_nFD_ECALveto_1e_cut", "#theta^{reco}_{e} vs. P^{reco}_{nFD} in 1e cut (ECALveto);#theta^{reco}_{e} [#circ];P^{reco}_{nFD} [GeV/c]", 100, 0,
                             45., 100, 0., Ebeam * 3.);
                ...
                TH2D* h_reco_phi_e_VS_theta_nFD_ECALveto_1e_cut =
                    new TH2D("reco_phi_e_VS_theta_nFD_ECALveto_1e_cut", "#phi^{reco}_{e} vs. #theta^{reco}_{nFD} in 1e cut (ECALveto);#phi^{reco}_{e} [#circ];#theta^{reco}_{nFD} [#circ]",
                ...
                TH2D* h_reco_theta_e_VS_phi_nFD_ECALveto_1e_cut =
                    new TH2D("reco_phi_e_VS_phi_nFD_ECALveto_1e_cut", "#theta^{reco}_{e} vs. #phi^{reco}_{nFD} in 1e cut (ECALveto);#theta^{reco}_{e} [#circ];#phi^{reco}_{nFD} [#circ]", 100,
                             0, 45., 100, -180., 180.);
...
#pragma endregion
                ...
                //     new TH2D("reco_P_nFD_VS_reco_L_ECAL_ECALveto_1e_cut", "P^{reco}_{nFD} vs. L^{reco}_{nFD,ECAL} in 1e cut (ECALveto);L^{reco}_{nFD,ECAL} [cm];P^{reco}_{nFD} [#circ]",
                //     100,
                ...
                // //              "P^{reco}_{nFD} vs. L^{eff}_{nFD,ECAL} in 1e cut (ECALveto);L^{eff}_{nFD,ECAL} = c#beta^{truth}t^{#beta^{reco}_{nFD}}_{ToF} [cm];P^{reco}_{nFD} [#circ]",
                // 100,
                // //              700., 850., 100, 0., Ebeam * 3.);
                ...
                //     new TH2D("reco_P_nFD_VS_reco_L_ECIN_ECALveto_1e_cut", "P^{reco}_{nFD} vs. L^{reco}_{nFD,ECIN} in 1e cut (ECALveto);L^{reco}_{nFD,ECIN} [cm];P^{reco}_{nFD} [#circ]",
                //     100,
                //              700., 850., 100, 0., Ebeam * 3.);
                ...
                // //              "P^{reco}_{nFD} vs. L^{eff}_{nFD,ECIN} in 1e cut (ECALveto);L^{eff}_{nFD,ECIN} = c#beta^{truth}t^{#beta^{reco}_{nFD}}_{ToF} [cm];P^{reco}_{nFD} [#circ]",
                // 100,
                // //              700., 850., 100, 0., Ebeam * 3.);
                ...
                TH2D* h_v_dist_VS_reco_P_nFD_ECALveto_1e_cut = new TH2D(
                    "v_dist_VS_reco_P_nFD_ECALveto_1e_cut", "v_dist vs. P^{reco}_{nFD} in 1e cut (ECALveto);v_dist [cm];P^{reco}_{nFD} [GeV/c]", 100, 0., 1000., 100, 0., Ebeam * 3.);
                ...
                TH2D* h_beta_n_VS_reco_P_nFD_ECALveto_1e_cut = new TH2D(
                    "beta_n_VS_reco_P_nFD_ECALveto_1e_cut", "#beta_{nFD} vs. P^{reco}_{nFD} in 1e cut (ECALveto);P^{reco}_{nFD} [GeV/c];#beta_{nFD}", 100, 0., Ebeam * 3., 100, 0, 1.1);
...
#pragma region /* Base histograms (matched) */
                ...
                TH2D* h_reco_P_e_VS_P_nFD_matched_1e_cut =
                    new TH2D("reco_P_e_VS_P_nFD_matched_1e_cut", "P^{reco}_{e} vs. P^{reco}_{nFD} in 1e cut (matched);P^{reco}_{e} [GeV/c];P^{reco}_{nFD} [GeV/c]", 100, 0., Ebeam * 2., 100,
                             0., Ebeam * 3.);
                ...
                TH2D* h_reco_phi_e_VS_P_nFD_matched_1e_cut =
                    new TH2D("reco_phi_e_VS_P_nFD_matched_1e_cut", "#phi^{reco}_{e} vs. P^{reco}_{nFD} in 1e cut (matched);#phi^{reco}_{e} [#circ];P^{reco}_{nFD} [GeV/c]", 100, -180., 180.,
                             100, 0., Ebeam * 3.);
                ...
                TH2D* h_reco_theta_e_VS_phi_nFD_matched_1e_cut =
                    new TH2D("reco_phi_e_VS_phi_nFD_matched_1e_cut", "#theta^{reco}_{e} vs. #phi^{reco}_{nFD} in 1e cut (matched);#theta^{reco}_{e} [#circ];#phi^{reco}_{nFD} [#circ]", 100,
                             0, 45., 100, -180., 180.);
...
#pragma endregion
                ...
                // //              "P^{reco}_{nFD} vs. L^{eff}_{nFD,ECAL} in 1e cut (matched);L^{eff}_{nFD,ECAL} = c#beta^{truth}t^{#beta^{reco}_{nFD}}_{ToF} [cm];P^{reco}_{nFD} [#circ]",
                // 100,
                // //              700., 850., 100, 0., Ebeam * 3.);
                ...
                // //              "P^{reco}_{nFD} vs. L^{eff}_{nFD,ECIN} in 1e cut (matched);L^{eff}_{nFD,ECIN} = c#beta^{truth}t^{#beta^{reco}_{nFD}}_{ToF} [cm];P^{reco}_{nFD} [#circ]",
                // 100,
                // //              700., 850., 100, 0., Ebeam * 3.);
                ...
                //     new TH2D("reco_P_nFD_VS_reco_L_ECOUT_matched_1e_cut", "P^{reco}_{nFD} vs. L^{reco}_{nFD,ECOUT} in 1e cut (matched);L^{reco}_{nFD,ECOUT} [cm];P^{reco}_{nFD} [#circ]",
                //     100,
                //              700., 850., 100, 0., Ebeam * 3.);
                ...
                // //              "P^{reco}_{nFD} vs. L^{eff}_{nFD,ECOUT} in 1e cut (matched);L^{eff}_{nFD,ECOUT} = c#beta^{truth}t^{#beta^{reco}_{nFD}}_{ToF} [cm];P^{reco}_{nFD} [#circ]",
                // 100,
                // //              700., 850., 100, 0., Ebeam * 3.);
                ...
                TH2D* h_beta_n_VS_reco_P_nFD_matched_1e_cut = new TH2D(
                    "beta_n_VS_reco_P_nFD_matched_1e_cut", "#beta_{nFD} vs. P^{reco}_{nFD} in 1e cut (matched);P^{reco}_{nFD} [GeV/c];#beta_{nFD}", 100, 0., Ebeam * 3., 100, 0, 1.1);
...
#pragma region /* Setting up FD neutrals (ECALveto) */
                    ...
                    if (NeutronsFD_ind_mom_max != -1) {
                        ...
                        bool NeutronPassVeto_1e_cut = NeutronECAL_Cut_Veto(allParticles, electrons, Ebeam, NeutronsFD_ind_mom_max, apply_PCAL_neutral_veto, cPart_veto_radius, nPart_veto_radius);
                        ...
                        for (int j = 0; j < allParticles.size(); j++) {
                            if (allParticles[j]->par()->getCharge() == 0) {
                                ...
                                if (neutral_hit_PCAL && (allParticles[j]->cal(clas12::PCAL)->getZ() != 0)) {
                                    ...
                                    h_v_dist_VS_reco_phi_nFD_minus_reco_phi_e_ECALveto_1e_cut->Fill(v_dist.Mag(), CalcdPhi(reco_P_nFD.Phi() * 180 / M_PI - reco_P_e.Phi() * 180 / M_PI),
                                                                                                    weight);
                                }
                            }
                        }
                        ...
                        for (int j = 0; j < allParticles.size(); j++) {
                            if (allParticles[j]->par()->getCharge() == 0) {
                                ...
                                if (neutral_hit_PCAL && (allParticles[j]->cal(clas12::PCAL)->getZ() != 0)) {
                                    ...
                                    h_v_dist_VS_reco_phi_nFD_minus_reco_phi_e_matched_1e_cut->Fill(v_dist.Mag(), CalcdPhi(reco_P_nFD.Phi() * 180 / M_PI - reco_P_e.Phi() * 180 / M_PI),
                                                                                                   weight);
                                }
                            }
                        }
