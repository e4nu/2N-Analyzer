...
void nFD_eff_test() {
    ...
    */
    ...
    string OutFolderName_ver_status = "_v11";
...
#pragma region /* Electron pre-selection */
                    ...
                    // // DC hit maps
                    // for (int i = 1; i <= 3; i++) {
                    //     h_dc_electron_hit_map_AallC_1e_cut[i] = new TH2D(Form("dc_electron_hit_map_AallC%d", i), Form("DC hitmap in region %d (before cuts);x [cm];y [cm]", i), 600, -300,
                    //     300, 600, -300, 300);
                    // }
...
#pragma endregion
                    ...
                    TH2D* h_v_dist_VS_reco_P_nFD_matched_1e_cut = new TH2D(
                        "v_dist_VS_reco_P_nFD_matched_1e_cut", "v_dist vs. P^{reco}_{nFD} in 1e cut (matched);v_dist [cm];P^{reco}_{nFD} [GeV/c]", 100, 0., 1000., 100, 0., Ebeam * 3.);
