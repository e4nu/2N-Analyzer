...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    hPlot1D hChi2_Electron_FD = hPlot1D("no #(e) cut", "", "#chi^{2}_{e}", "#chi^{2}_{e} histogram", "#chi^{2}_{e}",
                                        directories.Chi2_Directory_map["Chi2_All_e_Directory"], "01_Electron_chi2", -Chi2_boundary, Chi2_boundary, numTH1Dbins);

    hPlot1D hChi2_Proton_CD = hPlot1D("no #(e) cut", "CD", "#chi^{2}_{p}", "#chi^{2}_{p} histogram", "#chi^{2}_{p}",
                                      directories.Chi2_Directory_map["Chi2_All_e_Directory"], "02_Proton_chi2", -Chi2_boundary, Chi2_boundary, numTH1Dbins);
    ...
    hPlot1D hChi2_Electron_1e_cut_FD = hPlot1D("1e cut", "", "#chi^{2}_{e}", "#chi^{2}_{e} histogram", "#chi^{2}_{e}",
                                               directories.Chi2_Directory_map["Chi2_1e_cut_Directory"], "01_Electron_chi2", -Chi2_boundary, Chi2_boundary, numTH1Dbins);

    hPlot1D hChi2_Proton_1e_cut_CD = hPlot1D("1e cut", "CD", "#chi^{2}_{p}", "#chi^{2}_{p} histogram", "#chi^{2}_{p}",
                                             directories.Chi2_Directory_map["Chi2_1e_cut_Directory"], "02_Proton_chi2", -Chi2_boundary, Chi2_boundary, numTH1Dbins);
    ...
    hPlot1D hChi2_Kplus_1e_cut_CD = hPlot1D("1e cut", "CD", "#chi^{2}_{K^{+}}", "#chi^{2}_{K^{+}} histogram", "#chi^{2}_{K^{+}}",
                                            directories.Chi2_Directory_map["Chi2_1e_cut_Directory"], "03_Kplus_chi2", -Chi2_boundary, Chi2_boundary, numTH1Dbins);
    ...
    hPlot1D hChi2_Kminus_1e_cut_CD = hPlot1D("1e cut", "CD", "#chi^{2}_{K^{-}}", "#chi^{2}_{K^{-}} histogram", "#chi^{2}_{K^{-}}",
                                             directories.Chi2_Directory_map["Chi2_1e_cut_Directory"], "04_Kminus_chi2", -Chi2_boundary, Chi2_boundary, numTH1Dbins);
    ...
    hPlot1D hChi2_deuteron_1e_cut_CD = hPlot1D("1e cut", "CD", "#chi^{2}_{D}", "#chi^{2}_{D} histogram", "#chi^{2}_{D}",
                                               directories.Chi2_Directory_map["Chi2_1e_cut_Directory"], "07_deuteron_chi2", -Chi2_boundary, Chi2_boundary, numTH1Dbins);
    ...
    hPlot1D hChi2_Electron_pFDpCD_FD = hPlot1D("pFDpCD", "", "#chi^{2}_{e}", "#chi^{2}_{e} histogram", "#chi^{2}_{e}",
                                               directories.Chi2_Directory_map["Chi2_pFDpCD_Directory"], "01_Electron_Chi2_pFDpCD", -Chi2_boundary, Chi2_boundary,
                                               numTH1Dbins);

    hPlot1D hChi2_Proton_pFDpCD_CD = hPlot1D("pFDpCD", "CD", "#chi^{2}_{pCD}", "#chi^{2}_{pCD} histogram", "#chi^{2}_{pCD}",
                                             directories.Chi2_Directory_map["Chi2_pFDpCD_Directory"], "02_Proton_Chi2_pFDpCD", -Chi2_boundary, Chi2_boundary,
                                             numTH1Dbins);
    ...
    hPlot1D hChi2_Electron_nFDpCD_FD = hPlot1D("nFDpCD", "", "#chi^{2}_{e}", "#chi^{2}_{e} histogram", "#chi^{2}_{e}",
                                               directories.Chi2_Directory_map["Chi2_nFDpCD_Directory"], "01_Electron_Chi2_nFDpCD", -Chi2_boundary, Chi2_boundary,
                                               numTH1Dbins);

    hPlot1D hChi2_Proton_nFDpCD_CD = hPlot1D("nFDpCD", "CD", "#chi^{2}_{pCD}", "#chi^{2}_{pCD} histogram", "#chi^{2}_{pCD}",
                                             directories.Chi2_Directory_map["Chi2_nFDpCD_Directory"], "02_Proton_Chi2_nFDpCD", -Chi2_boundary, Chi2_boundary,
                                             numTH1Dbins);
...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    hPlot1D hdVy_Kminus_FD_1e_cut = hPlot1D("1e cut", "FD", "Vertex corr. dV^{K^{-}}_{y}", "Vertex correlation dV^{K^{-}}_{y}=V^{K^{-}}_{y}-V^{e}_{y}",
    ...
    hPlot1D hdVz_Kminus_FD_1e_cut = hPlot1D("1e cut", "FD", "Vertex corr. dV^{K^{-}}_{z}", "Vertex correlation dV^{K^{-}}_{z}=V^{K^{-}}_{z}-V^{e}_{z}",
    ...
    hPlot1D hdVx_Kminus_CD_1e_cut = hPlot1D("1e cut", "CD", "Vertex corr. dV^{K^{-}}_{x}", "Vertex correlation dV^{K^{-}}_{x}=V^{K^{-}}_{x}-V^{e}_{x}",
                                            "dV^{K^{-}}_{x} [cm]", directories.Vertex_Directory_map["Vertex_corr_Kminus_1e_cut_Vtx_Directory"],
                                            "01_dVx_Kminus", dV_lboundary_CD, dV_uboundary_CD, numTH1Dbins);
    hPlot1D hdVy_Kminus_CD_1e_cut = hPlot1D("1e cut", "CD", "Vertex corr. dV^{K^{-}}_{y}", "Vertex correlation dV^{K^{-}}_{y}=V^{K^{-}}_{y}-V^{e}_{y}",
                                            "dV^{K^{-}}_{y} [cm]", directories.Vertex_Directory_map["Vertex_corr_Kminus_1e_cut_Vtx_Directory"],
                                            "02_dVy_Kminus", dV_lboundary_CD, dV_uboundary_CD, numTH1Dbins);
    hPlot1D hdVz_Kminus_CD_1e_cut = hPlot1D("1e cut", "CD", "Vertex corr. dV^{K^{-}}_{z}", "Vertex correlation dV^{K^{-}}_{z}=V^{K^{-}}_{z}-V^{e}_{z}",
                                            "dV^{K^{-}}_{z} [cm]", directories.Vertex_Directory_map["Vertex_corr_Kminus_1e_cut_Vtx_Directory"],
                                            "03_dVz_Kminus", dV_lboundary_CD, dV_uboundary_CD, numTH1Dbins);
    hdVz_Kminus_CD_1e_cut.SetLogScalePlot(Log_scale_dVz_plots);

    hPlot1D hdVx_piplus_FD_1e_cut = hPlot1D("1e cut", "FD", "Vertex corr. dV^{#pi^{+}}_{x}", "Vertex correlation dV^{#pi^{+}}_{x}=V^{#pi^{+}}_{x}-V^{e}_{x}",
    ...
    hPlot1D hdVy_piplus_FD_1e_cut = hPlot1D("1e cut", "FD", "Vertex corr. dV^{#pi^{+}}_{y}", "Vertex correlation dV^{#pi^{+}}_{y}=V^{#pi^{+}}_{y}-V^{e}_{y}",
    ...
    hPlot1D hdVz_piplus_FD_1e_cut = hPlot1D("1e cut", "FD", "Vertex corr. dV^{#pi^{+}}_{z}", "Vertex correlation dV^{#pi^{+}}_{z}=V^{#pi^{+}}_{z}-V^{e}_{z}",
    ...
    hPlot1D hdVx_piplus_CD_1e_cut = hPlot1D("1e cut", "CD", "Vertex corr. dV^{#pi^{+}}_{x}", "Vertex correlation dV^{#pi^{+}}_{x}=V^{#pi^{+}}_{x}-V^{e}_{x}",
                                            "dV^{#pi^{+}}_{x} [cm]", directories.Vertex_Directory_map["Vertex_corr_piplus_1e_cut_Vtx_Directory"],
                                            "01_dVx_Piplus", dV_lboundary_CD, dV_uboundary_CD, numTH1Dbins);
    hPlot1D hdVy_piplus_CD_1e_cut = hPlot1D("1e cut", "CD", "Vertex corr. dV^{#pi^{+}}_{y}", "Vertex correlation dV^{#pi^{+}}_{y}=V^{#pi^{+}}_{y}-V^{e}_{y}",
                                            "dV^{#pi^{+}}_{y} [cm]", directories.Vertex_Directory_map["Vertex_corr_piplus_1e_cut_Vtx_Directory"],
                                            "02_dVy_Piplus", dV_lboundary_CD, dV_uboundary_CD, numTH1Dbins);
    hPlot1D hdVz_piplus_CD_1e_cut = hPlot1D("1e cut", "CD", "Vertex corr. dV^{#pi^{+}}_{z}", "Vertex correlation dV^{#pi^{+}}_{z}=V^{#pi^{+}}_{z}-V^{e}_{z}",
                                            "dV^{#pi^{+}}_{z} [cm]", directories.Vertex_Directory_map["Vertex_corr_piplus_1e_cut_Vtx_Directory"],
...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    hPlot2D hVcal_VS_EoP_pFDpCD_PCAL = hPlot2D("pFDpCD", "PCAL", "Vcal vs. SF", "ECAL V coordinate vs. SF", "ECAL V coordinate [cm]", "Sampling Fraction (SF)",
    ...
    hPlot2D hWcal_VS_EoP_pFDpCD_PCAL = hPlot2D("pFDpCD", "PCAL", "Wcal vs. SF", "ECAL W coordinate vs. SF", "ECAL W coordinate [cm]", "Sampling Fraction (SF)",
    ...
    hPlot2D hVcal_VS_EoP_nFDpCD_PCAL = hPlot2D("nFDpCD", "PCAL", "Vcal vs. SF", "ECAL V coordinate vs. SF", "ECAL V coordinate [cm]", "Sampling Fraction (SF)",
                                               directories.Fiducial_Directory_map["Edge_nFDpCD_PCAL_Directory"], "01_Vcal_VS_EoP_PCAL_nFDpCD",
                                               0, 50, SF_lboundary, SF_uboundary, numTH2Dbins, numTH2Dbins);
    hPlot2D hWcal_VS_EoP_nFDpCD_PCAL = hPlot2D("nFDpCD", "PCAL", "Wcal vs. SF", "ECAL W coordinate vs. SF", "ECAL W coordinate [cm]", "Sampling Fraction (SF)",
...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    hPlot1D hP_p_1e_cut_CD = hPlot1D("1e cut", "CD", "Proton momentum", "Proton momentum P_{p}", "P_{p} [GeV/c]",
                                     directories.Momentum_Directory_map["Momentum_1e_cut_Directory"], "02_P_p_1e_cut_CD", 0, beamE * 1.1, numTH1Dbins);
    hPlot1D hP_p_1e_cut_FD = hPlot1D("1e cut", "FD", "Proton momentum", "Proton momentum P_{p}", "P_{p} [GeV/c]",
                                     directories.Momentum_Directory_map["Momentum_1e_cut_Directory"], "02_P_p_1e_cut_FD", 0, beamE * 1.1, numTH1Dbins);
    ...
    hPlot1D hP_Kplus_1e_cut_CD = hPlot1D("1e cut", "CD", "K^{+} momentum", "K^{+} momentum P_{K^{+}}", "P_{K^{+}} [GeV/c]",
                                         directories.Momentum_Directory_map["Momentum_1e_cut_Directory"], "05_P_Kplus_1e_cut_CD", 0, beamE * 1.1, numTH1Dbins);
    hPlot1D hP_Kplus_1e_cut_FD = hPlot1D("1e cut", "FD", "K^{+} momentum", "K^{+} momentum P_{K^{+}}", "P_{K^{+}} [GeV/c]",
                                         directories.Momentum_Directory_map["Momentum_1e_cut_Directory"], "05_P_Kplus_1e_cut_FD", 0, beamE * 1.1, numTH1Dbins);

    hPlot1D hP_Kminus_1e_cut_CD = hPlot1D("1e cut", "CD", "K^{-} momentum", "K^{-} momentum P_{K^{-}}", "P_{K^{-}} [GeV/c]",
                                          directories.Momentum_Directory_map["Momentum_1e_cut_Directory"], "06_P_Kminus_1e_cut_CD", 0, beamE * 1.1, numTH1Dbins);
    hPlot1D hP_Kminus_1e_cut_FD = hPlot1D("1e cut", "FD", "K^{-} momentum", "K^{-} momentum P_{K^{-}}", "P_{K^{-}} [GeV/c]",
                                          directories.Momentum_Directory_map["Momentum_1e_cut_Directory"], "06_P_Kminus_1e_cut_FD", 0, beamE * 1.1, numTH1Dbins);
...
//                                            Momentum_lboundary, Momentum_uboundary, numTH1Dbins_Mom_eff_Plots);
    ...
    hPlot1D hP_n_APID_1n_ZOOMOUT_FD = hPlot1D("1n", "FD", "Neutron momentum APID - ZOOMOUT", "Neutron momentum P_{n} APID - ZOOMOUT", "P_{n} [GeV/c]",
                                              ...
                                              Momentum_lboundary, 20., numTH1Dbins);
    ...
    hPlot1D hP_nFD_APID_1n = hPlot1D("1n", "FD", "Leading FD neutron momentum APID", "Leading FD neutron momentum APID", "P_{n} [GeV/c]",
                                     ...
                                     Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    hPlot1D hP_nFD_APIDandNS_1n = hPlot1D("1n", "FD", "Leading FD neutron momentum APID&NC", "Leading FD neutron momentum APID&NC", "P_{n} [GeV/c]",
                                          directories.Momentum_Directory_map["Analysis_plots_momentum_1n_Directory"], "01b_P_nFD_APIDandNS_1n_FD",
                                          Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    hPlot1D hP_nFD_APID_1n_ZOOMOUT = hPlot1D("1n", "FD", "Leading FD neutron momentum APID - ZOOMOUT", "Leading FD neutron momentum APID - ZOOMOUT", "P_{n} [GeV/c]",
                                             directories.Momentum_Directory_map["Analysis_plots_momentum_1n_Directory"], "01c_P_nFD_APID_1n_ZOOMOUT_FD",
                                             Momentum_lboundary, 20., numTH1Dbins);
    hPlot1D hP_nFD_APIDandNS_1n_ZOOMOUT = hPlot1D("1n", "FD", "Leading FD neutron momentum APID&NC - ZOOMOUT",
                                                  ...
                                                  directories.Momentum_Directory_map["Analysis_plots_momentum_1n_Directory"], "01d_P_nFD_APIDandNS_1n_ZOOMOUT_FD",
                                                  Momentum_lboundary, 20., numTH1Dbins);
    ...
    hPlot1D hP_p_1_2p = hPlot1D("2p", "", "Leading proton P_{1}", "Leading proton momentum P_{1}", "P_{1} [GeV/c]",
                                directories.Momentum_Directory_map["Momentum_2p_Directory"], "07_P_p_1_2p", Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    hPlot1D hP_p_2_2p = hPlot1D("2p", "", "Recoil proton P_{2}", "Recoil proton momentum P_{2}", "P_{2} [GeV/c]",
                                directories.Momentum_Directory_map["Momentum_2p_Directory"], "07_P_p_2_2p", Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    //</editor-fold>
    ...
    hPlot1D hP_piminus_APID_pFDpCD_CD = hPlot1D("pFDpCD", "CD", "#pi^{-} momentum APID", "#pi^{-} momentum P_{#pi^{-}} APID", "P_{#pi^{-}} [GeV/c]",
                                                directories.Momentum_Directory_map["Momentum_pFDpCD_Directory"], "05a_P_piminus_APID_pFDpCD_CD",
                                                Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    hPlot1D hP_piminus_BPID_pFDpCD_CD = hPlot1D("pFDpCD", "CD", "#pi^{-} momentum BPID", "#pi^{-} momentum P_{#pi^{-}} BPID", "P_{#pi^{-}} [GeV/c]",
                                                directories.Momentum_Directory_map["Momentum_pFDpCD_Directory"], "05b_P_piminus_BPID_pFDpCD_CD",
                                                Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    hPlot1D hP_piminus_APID_pFDpCD_FD = hPlot1D("pFDpCD", "FD", "#pi^{-} momentum APID", "#pi^{-} momentum P_{#pi^{-}} APID", "P_{#pi^{-}} [GeV/c]",
                                                directories.Momentum_Directory_map["Momentum_pFDpCD_Directory"], "05c_P_piminus_APID_pFDpCD_FD",
                                                Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    hPlot1D hP_piminus_BPID_pFDpCD_FD = hPlot1D("pFDpCD", "FD", "#pi^{-} momentum BPID", "#pi^{-} momentum P_{#pi^{-}} BPID", "P_{#pi^{-}} [GeV/c]",
    ...
    hPlot1D hP_piminus_APID_nFDpCD_CD = hPlot1D("nFDpCD", "CD", "#pi^{-} momentum APID", "#pi^{-} momentum P_{#pi^{-}} APID", "P_{#pi^{-}} [GeV/c]",
                                                directories.Momentum_Directory_map["Momentum_nFDpCD_Directory"], "05a_P_piminus_APID_nFDpCD_CD",
                                                Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    hPlot1D hP_piminus_BPID_nFDpCD_CD = hPlot1D("nFDpCD", "CD", "#pi^{-} momentum BPID", "#pi^{-} momentum P_{#pi^{-}} BPID", "P_{#pi^{-}} [GeV/c]",
                                                directories.Momentum_Directory_map["Momentum_nFDpCD_Directory"], "05b_P_piminus_BPID_nFDpCD_CD",
                                                Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    hPlot1D hP_piminus_APID_nFDpCD_FD = hPlot1D("nFDpCD", "FD", "#pi^{-} momentum APID", "#pi^{-} momentum P_{#pi^{-}} APID", "P_{#pi^{-}} [GeV/c]",
                                                directories.Momentum_Directory_map["Momentum_nFDpCD_Directory"], "05c_P_piminus_APID_nFDpCD_FD",
                                                Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    hPlot1D hP_piminus_BPID_nFDpCD_FD = hPlot1D("nFDpCD", "FD", "#pi^{-} momentum BPID", "#pi^{-} momentum P_{#pi^{-}} BPID", "P_{#pi^{-}} [GeV/c]",
    ...
    hPlot1D hP_nL_APID_nFDpCD_FD = hPlot1D("nFDpCD", "FD", "Leading neutron momentum APID", "Leading neutron momentum P_{n} APID", "P_{n} [GeV/c]",
                                           directories.Momentum_Directory_map["Momentum_nFDpCD_Directory"], "07a_P_n_APID_nFDpCD_FD",
                                           Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    hPlot1D hP_nL_APIDandNS_nFDpCD_FD = hPlot1D("nFDpCD", "FD", "Leading neutron momentum APID&NC", "Leading neutron momentum P_{n} APID&NC", "P_{n} [GeV/c]",
                                                directories.Momentum_Directory_map["Momentum_nFDpCD_Directory"], "07b_P_n_APIDandNS_nFDpCD_FD",
                                                Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    //</editor-fold>
...
//                                       "02e_P_rel_pFDpCD", CDMomentum_lboundary, CDMomentum_uboundary, numTH1Dbins);
    hPlot2D hP_tot_mu_vs_P_rel_mu_pFDpCD = hPlot2D("pFDpCD", "", "P_{tot}^{#mu} vs. P_{rel}^{#mu}", "P_{tot}^{#mu} vs. P_{rel}^{#mu}",
                                                   ...
                                                   directories.Momentum_Directory_map["Analysis_plots_momentum_pFDpCD_Directory"], "02f_P_tot_vs_P_rel",
...
//                                       "02e_P_rel_nFDpCD", CDMomentum_lboundary, CDMomentum_uboundary, numTH1Dbins);
    hPlot2D hP_tot_mu_vs_P_rel_mu_nFDpCD = hPlot2D("nFDpCD", "", "P_{tot}^{#mu} vs. P_{rel}^{#mu}", "P_{tot}^{#mu} vs. P_{rel}^{#mu}",
                                                   ...
                                                   directories.Momentum_Directory_map["Analysis_plots_momentum_nFDpCD_Directory"], "02f_P_tot_vs_P_rel",
                                                   Momentum_lboundary, Momentum_uboundary, -CDMomentum_uboundary, CDMomentum_lboundary, numTH2Dbins, numTH2Dbins);
...
// ======================================================================================================================================================================
    ...
    hPlot2D hBeta_vs_P_positive_part_1e_cut_CD = hPlot2D("all particles", "1e cut", "CD", "#beta vs. P & q = +1", "#beta vs. P for all particles with q = +1",
                                                         ...
                                                         "01_Beta_vs_P_q_p1_1e_cut_CD", 0, beamE * 1.1, 0, 1.7, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_positive_part_1e_cut_FD = hPlot2D("all particles", "1e cut", "FD", "#beta vs. P & q = +1", "#beta vs. P for all particles with q = +1",
                                                         "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_1e_cut_Directory"],
                                                         "01_Beta_vs_P_q_p1_1e_cut_FD", 0, beamE * 1.1, 0, 1.7, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_neutral_part_1e_cut_CD = hPlot2D("all particles", "1e cut", "CD", "#beta vs. P & q = 0", "#beta vs. P for all particles with q = 0",
                                                        "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_1e_cut_Directory"],
                                                        "02_Beta_vs_P_q_0_1e_cut_CD", 0, beamE * 1.1, 0, 1.7, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_neutral_part_1e_cut_FD = hPlot2D("all particles", "1e cut", "FD", "#beta vs. P & q = 0", "#beta vs. P for all particles with q = 0",
                                                        "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_1e_cut_Directory"],
                                                        "02_Beta_vs_P_q_0_1e_cut_FD", 0, beamE * 1.1, 0, 1.7, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_negative_part_1e_cut_CD = hPlot2D("all particles", "1e cut", "CD", "#beta vs. P & q = -1", "#beta vs. P for all particles with q = -1",
                                                         "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_1e_cut_Directory"],
                                                         "03_Beta_vs_P_q_m1_1e_cut_CD", 0, beamE * 1.1, 0, 1.7, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_negative_part_1e_cut_FD = hPlot2D("all particles", "1e cut", "FD", "#beta vs. P & q = -1", "#beta vs. P for all particles with q = -1",
                                                         "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_1e_cut_Directory"],
                                                         "03_Beta_vs_P_q_m1_1e_cut_FD", 0, beamE * 1.1, 0, 1.7, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    //</editor-fold>
    ...
    hPlot2D hBeta_vs_P_pFDpCD_Electrons_Only_FD = hPlot2D("electrons only", "pFDpCD", "FD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                          directories.Beta_Directory_map["Beta_VS_P_pFDpCD_Directory"], "02_Beta_vs_P_pFDpCD_Electrons_Only_FD",
                                                          0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);

    hPlot2D hBeta_vs_P_pFDpCD_Protons_Only_CD = hPlot2D("protons only", "pFDpCD", "CD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                        directories.Beta_Directory_map["Beta_VS_P_pFDpCD_Directory"], "03_Beta_vs_P_pFDpCD_Protons_Only_CD",
                                                        0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_pFDpCD_Protons_Only_FD = hPlot2D("protons only", "pFDpCD", "FD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                        directories.Beta_Directory_map["Beta_VS_P_pFDpCD_Directory"], "03_Beta_vs_P_pFDpCD_Protons_Only_FD",
                                                        0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);

    hPlot2D hBeta_vs_P_pFD_pFDpCD_Protons_Only_FD = hPlot2D("", "pFDpCD", "FD", "#beta vs. FD proton momentum", "#beta vs. FD proton momentum", "P_{pFD} [GeV/c]",
                                                            "#beta", directories.Beta_Directory_map["Beta_VS_P_pFDpCD_Directory"],
                                                            "04a_Beta_vs_P_pFD_pFDpCD_Protons_Only_CD",
                                                            0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_pCD_pFDpCD_Protons_Only_CD = hPlot2D("", "pFDpCD", "CD", "#beta vs. CD proton momentum", "#beta vs. CD proton momentum", "P_{pCD} [GeV/c]",
                                                            "#beta", directories.Beta_Directory_map["Beta_VS_P_pFDpCD_Directory"],
    ...
    hPlot2D hBeta_vs_P_positive_part_pFDpCD_CD = hPlot2D("all particles", "pFDpCD", "CD", "#beta vs. P & q = +1", "#beta vs. P for all particles with q = +1",
                                                         "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_pFDpCD_Directory"],
                                                         "01_Beta_vs_P_q_p1_pFDpCD_CD", 0, beamE * 1.1, 0, 1.5, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_positive_part_pFDpCD_FD = hPlot2D("all particles", "pFDpCD", "FD", "#beta vs. P & q = +1", "#beta vs. P for all particles with q = +1",
                                                         "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_pFDpCD_Directory"],
                                                         "01_Beta_vs_P_q_p1_pFDpCD_FD", 0, beamE * 1.1, 0, 1.5, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_neutral_part_pFDpCD_CD = hPlot2D("all particles", "pFDpCD", "CD", "#beta vs. P & q = 0", "#beta vs. P for all particles with q = 0",
                                                        "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_pFDpCD_Directory"],
                                                        "02_Beta_vs_P_q_0_pFDpCD_CD", 0, beamE * 1.1, 0, 1.5, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_neutral_part_pFDpCD_FD = hPlot2D("all particles", "pFDpCD", "FD", "#beta vs. P & q = 0", "#beta vs. P for all particles with q = 0",
                                                        "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_pFDpCD_Directory"],
                                                        "02_Beta_vs_P_q_0_pFDpCD_FD", 0, beamE * 1.1, 0, 1.5, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_negative_part_pFDpCD_CD = hPlot2D("all particles", "pFDpCD", "CD", "#beta vs. P & q = -1", "#beta vs. P for all particles with q = -1",
                                                         "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_pFDpCD_Directory"],
                                                         "03_Beta_vs_P_q_m1_pFDpCD_CD", 0, beamE * 1.1, 0, 1.5, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_negative_part_pFDpCD_FD = hPlot2D("all particles", "pFDpCD", "FD", "#beta vs. P & q = -1", "#beta vs. P for all particles with q = -1",
                                                         "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_pFDpCD_Directory"],
                                                         "03_Beta_vs_P_q_m1_pFDpCD_FD", 0, beamE * 1.1, 0, 1.5, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    //</editor-fold>
    ...
    hPlot2D hBeta_vs_P_nFDpCD_Electrons_Only_FD = hPlot2D("electrons only", "nFDpCD", "FD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                          directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"], "01_Beta_vs_P_Electrons_Only_FD_nFDpCD",
                                                          0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);

    hPlot2D hBeta_vs_P_nFDpCD_Neutrons_Only_CD = hPlot2D("id. neutrons only", "nFDpCD", "CD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                         directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"], "02_Beta_vs_P_id_Neutrons_Only_CD_nFDpCD",
                                                         0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_nFDpCD_Neutrons_Only_FD = hPlot2D("id. neutrons only", "nFDpCD", "FD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                         directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"], "02_Beta_vs_P_id_Neutrons_Only_FD_nFDpCD",
                                                         0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_nFDpCD_Neutrons_Only_ZOOMOUT_FD = hPlot2D("id. neutrons only", "nFDpCD", "FD", "#beta vs. P - ZOOMOUT", "#beta vs. P", "P [GeV/c]", "#beta",
                                                                 directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"],
                                                                 "02_Beta_vs_P_id_Neutrons_Only_ZOOMOUT_FD_nFDpCD",
                                                                 0, P_boundary, 0, 2, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);

    hPlot2D hBeta_vs_P_nFDpCD_Neutrons_Only_from_photons_FD = hPlot2D("id. neutrons", "nFDpCD", "FD", "#beta vs. P", " Cond. to id. neutron's #beta vs. P from 'photons'",
                                                                      "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"],
    ...
    hPlot2D hBeta_vs_P_nFDpCD_Photons_Only_CD = hPlot2D("id. photons only", "nFDpCD", "CD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                        directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"], "03_Beta_vs_P_id_Photons_Only_CD_nFDpCD",
                                                        0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_nFDpCD_Photons_Only_FD = hPlot2D("id. photons only", "nFDpCD", "FD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                        directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"], "03_Beta_vs_P_id_Photons_Only_FD_nFDpCD",
                                                        0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);

    hPlot2D hBeta_vs_P_nFDpCD_Protons_Only_CD = hPlot2D("id. protons only", "nFDpCD", "CD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                        directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"], "04_Beta_vs_P_id_Protons_Only_CD_nFDpCD",
                                                        0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_nFDpCD_Protons_Only_FD = hPlot2D("id. protons only", "nFDpCD", "FD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                        directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"], "04_Beta_vs_P_id_Protons_Only_FD_nFDpCD",
                                                        0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);

    hPlot2D hBeta_vs_P_nFDpCD_Piplus_Only_CD = hPlot2D("id. #pi^{+} only", "nFDpCD", "CD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                       directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"], "05_Beta_vs_P_id_piplus_Only_CD_nFDpCD",
                                                       0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_nFDpCD_Piplus_Only_FD = hPlot2D("id. #pi^{+} only", "nFDpCD", "FD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                       directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"], "05_Beta_vs_P_id_piplus_Only_FD_nFDpCD",
                                                       0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);

    hPlot2D hBeta_vs_P_nFDpCD_Piminus_Only_CD = hPlot2D("id. #pi^{-} only", "nFDpCD", "CD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                        directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"], "06_Beta_vs_P_id_piminus_Only_CD_nFDpCD",
                                                        0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_nFDpCD_Piminus_Only_FD = hPlot2D("id. #pi^{-} only", "nFDpCD", "FD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                        directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"], "06_Beta_vs_P_id_piminus_Only_FD_nFDpCD",
                                                        0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);

    hPlot2D hBeta_vs_P_nFDpCD_Kplus_Only_CD = hPlot2D("id. K^{+} only", "nFDpCD", "CD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                      directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"], "05_Beta_vs_P_id_Kplus_Only_CD_nFDpCD",
                                                      0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_nFDpCD_Kplus_Only_FD = hPlot2D("id. K^{+} only", "nFDpCD", "FD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                      directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"], "05_Beta_vs_P_id_Kplus_Only_FD_nFDpCD",
                                                      0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);

    hPlot2D hBeta_vs_P_nFDpCD_Kminus_Only_CD = hPlot2D("id. K^{-} only", "nFDpCD", "CD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                       directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"], "06_Beta_vs_P_id_Kminus_Only_CD_nFDpCD",
                                                       0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_nFDpCD_Kminus_Only_FD = hPlot2D("id. K^{-} only", "nFDpCD", "FD", "#beta vs. P", "#beta vs. P", "P [GeV/c]", "#beta",
                                                       directories.Beta_Directory_map["Beta_VS_P_nFDpCD_Directory"], "06_Beta_vs_P_id_Kminus_Only_FD_nFDpCD",
                                                       0, P_boundary, 0, Beta_boundary, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    //</editor-fold>

    //<editor-fold desc="Beta vs. P by charge (nFDpCD)">
    hPlot2D hBeta_vs_P_pos_part_nFDpCD_CD = hPlot2D("all particles", "nFDpCD", "CD", "#beta vs. P & q = +1", "#beta vs. P for all particles with q = +1",
                                                    "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_nFDpCD_Directory"],
                                                    "01_Beta_vs_P_q_p1_nFDpCD_CD", 0, beamE * 1.1, 0, 1.5, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_pos_part_nFDpCD_FD = hPlot2D("all particles", "nFDpCD", "FD", "#beta vs. P & q = +1", "#beta vs. P for all particles with q = +1",
                                                    "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_nFDpCD_Directory"],
                                                    "01_Beta_vs_P_q_p1_nFDpCD_FD", 0, beamE * 1.1, 0, 1.5, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_neut_part_nFDpCD_CD = hPlot2D("all particles", "nFDpCD", "CD", "#beta vs. P & q = 0", "#beta vs. P for all particles with q = 0",
                                                     "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_nFDpCD_Directory"],
                                                     "02_Beta_vs_P_q_0_nFDpCD_CD", 0, beamE * 1.1, 0, 1.5, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_neut_part_nFDpCD_FD = hPlot2D("all particles", "nFDpCD", "FD", "#beta vs. P & q = 0", "#beta vs. P for all particles with q = 0",
                                                     "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_nFDpCD_Directory"],
                                                     "02_Beta_vs_P_q_0_nFDpCD_FD", 0, beamE * 1.1, 0, 1.5, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_neg_part_nFDpCD_CD = hPlot2D("all particles", "nFDpCD", "CD", "#beta vs. P & q = -1", "#beta vs. P for all particles with q = -1",
                                                    "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_nFDpCD_Directory"],
                                                    "03_Beta_vs_P_q_m1_nFDpCD_CD", 0, beamE * 1.1, 0, 1.5, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    hPlot2D hBeta_vs_P_neg_part_nFDpCD_FD = hPlot2D("all particles", "nFDpCD", "FD", "#beta vs. P & q = -1", "#beta vs. P for all particles with q = -1",
                                                    "P [GeV/c]", "#beta", directories.Beta_Directory_map["Beta_VS_P_by_charge_nFDpCD_Directory"],
                                                    "03_Beta_vs_P_q_m1_nFDpCD_FD", 0, beamE * 1.1, 0, 1.5, numTH2Dbins_Beta_Plots, numTH2Dbins_Beta_Plots);
    //</editor-fold>
...
// Theta_e --------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    TH1D *hTheta_e_All_Int_1p_FD = new TH1D("#theta_{e} (All Int., 1p, FD)", "#theta_{e} of Outgoing Electron (All Int., 1p, FD);#theta_{e} [Deg];",
                                            numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    ...
    TH1D *hTheta_e_All_Int_1n_FD = new TH1D("#theta_{e} (All Int., 1n, FD)", "#theta_{e} of Outgoing Electron (All Int., 1n, FD);#theta_{e} [Deg];",
                                            numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    ...
    TH1D *hTheta_e_All_Int_2p_FD = new TH1D("#theta_{e} (All Int., 2p, FD)", "#theta_{e} of Outgoing Electron (All Int., 2p, FD);#theta_{e} [Deg];",
                                            numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
...
// Phi_e ----------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    TH1D *hPhi_e_1e_cut_FD = new TH1D("#phi_{e} (1e Cut, FD)", "#phi_{e} of Outgoing Electron (All Int., 1e Cut, FD);#phi_{e} [Deg];", numTH1Dbins_Ang_Plots,
...
// Other angle plots ----------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    hPlot2D hdTheta_LnFD_p_VS_dPhi_LnFD_p_Protons_Vetoed_1e_cut = hPlot2D("1e cut", "FD", "#Delta#theta_{LnFD,pFD} vs. #Delta#phi_{LnFD,pFD} Vetoed",
                                                                          ...
                                                                          "#Delta#phi_{LnFD,pFD} = #phi_{n}^{ECIN/ECOUT} - #phi_{pFD}^{ECAL} [Deg]",
                                                                          "#Delta#theta_{LnFD,pFD} = #theta_{n}^{ECIN/ECOUT} - #theta_{pFD}^{ECAL} [Deg]",
                                                                          directories.Angle_Directory_map["Neutron_veto_1e_cut_Directory"],
    ...
    hPlot2D hdTheta_nFD_p_VS_dPhi_nFD_p_Protons_BV_1e_cut = hPlot2D("1e cut", "FD", "#Delta#theta_{nFD,pFD} vs. #Delta#phi_{nFD,pFD} BV",
                                                                    "'Neutron Hits' vs. Proton Hits - Before Veto",
                                                                    "#Delta#phi_{nFD,pFD} = #phi_{n}^{ECIN/ECOUT} - #phi_{pFD}^{ECAL} [Deg]",
                                                                    "#Delta#theta_{nFD,pFD} = #theta_{n}^{ECIN/ECOUT} - #theta_{pFD}^{ECAL} [Deg]",
                                                                    directories.Angle_Directory_map["Neutron_veto_1e_cut_Directory"],
...
// Neutron veto plots (1n) ----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    hPlot2D hdTheta_n_e_VS_dPhi_n_e_Electrons_BV_1n = hPlot2D("1n", "FD", "#Delta#theta_{n,e} vs. #Delta#phi_{n,e} BV",
                                                              "'Neutron Hits' vs. Electron Hits - Before Veto",
                                                              "#Delta#phi_{n,e} = #phi_{n}^{ECIN/ECOUT} - #phi_{e}^{ECAL} [Deg]",
                                                              "#Delta#theta_{n,e} = #theta_{n}^{ECIN/ECOUT} - #theta_{e}^{ECAL} [Deg]",
...
// Theta_pFD ------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    TH1D *hTheta_pFD_All_Int_pFDpCD_FD = new TH1D("#theta_{pFD} (All Int., pFDpCD)", "#theta_{pFD} of FD proton (All Int., pFDpCD);#theta_{pFD} [Deg];",
                                                  numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_pFD_QEL_pFDpCD_FD = new TH1D("#theta_{pFD} (QEL Only, pFDpCD)", "#theta_{pFD} of FD proton (QEL Only, pFDpCD);#theta_{pFD} [Deg];",
                                              numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_pFD_MEC_pFDpCD_FD = new TH1D("#theta_{pFD} (MEC Only, pFDpCD)", "#theta_{pFD} of FD proton (MEC Only, pFDpCD);#theta_{pFD} [Deg];",
                                              numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_pFD_RES_pFDpCD_FD = new TH1D("#theta_{pFD} (RES Only, pFDpCD)", "#theta_{pFD} of FD proton (RES Only, pFDpCD);#theta_{pFD} [Deg];",
                                              numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_pFD_DIS_pFDpCD_FD = new TH1D("#theta_{pFD} (DIS Only, pFDpCD)", "#theta_{pFD} of FD proton (DIS Only, pFDpCD);#theta_{pFD} [Deg];",
                                              numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
...
// Theta_pCD ------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    TH1D *hTheta_pCD_All_Int_pFDpCD_CD = new TH1D("#theta_{pCD} (All Int., pFDpCD)", "#theta_{pCD} of CD proton (All Int., pFDpCD);#theta_{pCD} [Deg];",
                                                  numTH1Dbins_Ang_Plots, 30, 155);
    TH1D *hTheta_pCD_QEL_pFDpCD_CD = new TH1D("#theta_{pCD} (QEL Only, pFDpCD)", "#theta_{pCD} of CD proton (QEL Only, pFDpCD);#theta_{pCD} [Deg];",
                                              numTH1Dbins_Ang_Plots, 30, 155);
    TH1D *hTheta_pCD_MEC_pFDpCD_CD = new TH1D("#theta_{pCD} (MEC Only, pFDpCD)", "#theta_{pCD} of CD proton (MEC Only, pFDpCD);#theta_{pCD} [Deg];",
                                              numTH1Dbins_Ang_Plots, 30, 155);
    TH1D *hTheta_pCD_RES_pFDpCD_CD = new TH1D("#theta_{pCD} (RES Only, pFDpCD)", "#theta_{pCD} of CD proton (RES Only, pFDpCD);#theta_{pCD} [Deg];",
                                              numTH1Dbins_Ang_Plots, 30, 155);
    TH1D *hTheta_pCD_DIS_pFDpCD_CD = new TH1D("#theta_{pCD} (DIS Only, pFDpCD)", "#theta_{pCD} of CD proton (DIS Only, pFDpCD);#theta_{pCD} [Deg];",
                                              numTH1Dbins_Ang_Plots, 30, 155);
...
// Theta_tot ------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    TH1D *hTheta_tot_QEL_pFDpCD = new TH1D("#theta_{tot} (QEL Only, pFDpCD)", "#theta_{tot} of total 3-momentum (QEL Only, pFDpCD);#theta_{tot} [Deg];",
                                           numTH1Dbins_Ang_Plots, Opening_Ang_narrow_lboundary, Opening_Ang_narrow_uboundary);
    TH1D *hTheta_tot_MEC_pFDpCD = new TH1D("#theta_{tot} (MEC Only, pFDpCD)", "#theta_{tot} of total 3-momentum (MEC Only, pFDpCD);#theta_{tot} [Deg];",
                                           numTH1Dbins_Ang_Plots, Opening_Ang_narrow_lboundary, Opening_Ang_narrow_uboundary);
    TH1D *hTheta_tot_RES_pFDpCD = new TH1D("#theta_{tot} (RES Only, pFDpCD)", "#theta_{tot} of total 3-momentum (RES Only, pFDpCD);#theta_{tot} [Deg];",
                                           numTH1Dbins_Ang_Plots, Opening_Ang_narrow_lboundary, Opening_Ang_narrow_uboundary);
    TH1D *hTheta_tot_DIS_pFDpCD = new TH1D("#theta_{tot} (DIS Only, pFDpCD)", "#theta_{tot} of total 3-momentum (DIS Only, pFDpCD);#theta_{tot} [Deg];",
                                           numTH1Dbins_Ang_Plots, Opening_Ang_narrow_lboundary, Opening_Ang_narrow_uboundary);
...
// Phi_tot --------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    TH1D *hPhi_tot_All_Int_pFDpCD = new TH1D("#phi_{tot} (All Int., pFDpCD)", "#phi_{tot} of total 3-momentum (All Int., pFDpCD);#phi_{tot} [Deg];",
                                             numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
...
// Phi_rel --------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    TH1D *hPhi_rel_All_Int_pFDpCD = new TH1D("#phi_{rel} (All Int., pFDpCD)", "#phi_{rel} of relative 3-momentum (All Int., pFDpCD);#phi_{rel} [Deg];",
                                             numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
...
// Theta_nFD ------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    TH1D *hTheta_nFD_All_Int_nFDpCD_FD = new TH1D("#theta_{nFD} (All Int., nFDpCD)", "#theta_{nFD} of FD neutron (All Int., nFDpCD);#theta_{nFD} [Deg];",
                                                  numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_nFD_QEL_nFDpCD_FD = new TH1D("#theta_{nFD} (QEL Only, nFDpCD)", "#theta_{nFD} of FD neutron (QEL Only, nFDpCD);#theta_{nFD} [Deg];",
                                              numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_nFD_MEC_nFDpCD_FD = new TH1D("#theta_{nFD} (MEC Only, nFDpCD)", "#theta_{nFD} of FD neutron (MEC Only, nFDpCD);#theta_{nFD} [Deg];",
                                              numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_nFD_RES_nFDpCD_FD = new TH1D("#theta_{nFD} (RES Only, nFDpCD)", "#theta_{nFD} of FD neutron (RES Only, nFDpCD);#theta_{nFD} [Deg];",
                                              numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_nFD_DIS_nFDpCD_FD = new TH1D("#theta_{nFD} (DIS Only, nFDpCD)", "#theta_{nFD} of FD neutron (DIS Only, nFDpCD);#theta_{nFD} [Deg];",
                                              numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
...
// Theta_pCD ------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    TH1D *hTheta_pCD_All_Int_nFDpCD_CD = new TH1D("#theta_{pCD} (All Int., nFDpCD)", "#theta_{pCD} of CD proton (All Int., nFDpCD);#theta_{pCD} [Deg];",
                                                  numTH1Dbins_Ang_Plots, 30, 155);
    TH1D *hTheta_pCD_QEL_nFDpCD_CD = new TH1D("#theta_{pCD} (QEL Only, nFDpCD)", "#theta_{pCD} of CD proton (QEL Only, nFDpCD);#theta_{pCD} [Deg];",
                                              numTH1Dbins_Ang_Plots, 30, 155);
    TH1D *hTheta_pCD_MEC_nFDpCD_CD = new TH1D("#theta_{pCD} (MEC Only, nFDpCD)", "#theta_{pCD} of CD proton (MEC Only, nFDpCD);#theta_{pCD} [Deg];",
                                              numTH1Dbins_Ang_Plots, 30, 155);
    TH1D *hTheta_pCD_RES_nFDpCD_CD = new TH1D("#theta_{pCD} (RES Only, nFDpCD)", "#theta_{pCD} of CD proton (RES Only, nFDpCD);#theta_{pCD} [Deg];",
                                              numTH1Dbins_Ang_Plots, 30, 155);
    TH1D *hTheta_pCD_DIS_nFDpCD_CD = new TH1D("#theta_{pCD} (DIS Only, nFDpCD)", "#theta_{pCD} of CD proton (DIS Only, nFDpCD);#theta_{pCD} [Deg];",
                                              numTH1Dbins_Ang_Plots, 30, 155);
...
// Theta_tot ------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    TH1D *hTheta_tot_All_Int_nFDpCD = new TH1D("#theta_{tot} (All Int., nFDpCD)", "#theta_{tot} of total 3-momentum (All Int., nFDpCD);#theta_{tot} [Deg];",
                                               numTH1Dbins_Ang_Plots, Opening_Ang_narrow_lboundary, Opening_Ang_narrow_uboundary);
    TH1D *hTheta_tot_QEL_nFDpCD = new TH1D("#theta_{tot} (QEL Only, nFDpCD)", "#theta_{tot} of total 3-momentum (QEL Only, nFDpCD);#theta_{tot} [Deg];",
                                           numTH1Dbins_Ang_Plots, Opening_Ang_narrow_lboundary, Opening_Ang_narrow_uboundary);
    TH1D *hTheta_tot_MEC_nFDpCD = new TH1D("#theta_{tot} (MEC Only, nFDpCD)", "#theta_{tot} of total 3-momentum (MEC Only, nFDpCD);#theta_{tot} [Deg];",
                                           numTH1Dbins_Ang_Plots, Opening_Ang_narrow_lboundary, Opening_Ang_narrow_uboundary);
    TH1D *hTheta_tot_RES_nFDpCD = new TH1D("#theta_{tot} (RES Only, nFDpCD)", "#theta_{tot} of total 3-momentum (RES Only, nFDpCD);#theta_{tot} [Deg];",
                                           numTH1Dbins_Ang_Plots, Opening_Ang_narrow_lboundary, Opening_Ang_narrow_uboundary);
    TH1D *hTheta_tot_DIS_nFDpCD = new TH1D("#theta_{tot} (DIS Only, nFDpCD)", "#theta_{tot} of total 3-momentum (DIS Only, nFDpCD);#theta_{tot} [Deg];",
                                           numTH1Dbins_Ang_Plots, Opening_Ang_narrow_lboundary, Opening_Ang_narrow_uboundary);
...
// Phi_tot --------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    TH1D *hPhi_tot_All_Int_nFDpCD = new TH1D("#phi_{tot} (All Int., nFDpCD)", "#phi_{tot} of total 3-momentum (All Int., nFDpCD);#phi_{tot} [Deg];",
                                             numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
...
// Phi_rel --------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    TH1D *hPhi_rel_All_Int_nFDpCD = new TH1D("#phi_{rel} (All Int., nFDpCD)", "#phi_{rel} of relative 3-momentum (All Int., nFDpCD);#phi_{rel} [Deg];",
                                             numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
...
// Theta_nFD_vs_theta_pCD for Theta_nFD_pCD < 20 (nFDpCD, CD & FD) --------------------------------------------------------------------------------------------------------------
    ...
    TH2D *hTheta_nFD_vs_theta_pCD_for_Theta_nFD_pCD_10_nFDpCD = new TH2D("#theta_{nFD} vs. #theta_{nFD} for #theta_{nFD,pCD}<20#circ (All Int., nFDpCD)",
                                                                         "#theta_{nFD} vs. #theta_{pCD} for #theta_{nFD,pCD}<20#circ (All Int., nFDpCD);"
                                                                         "#theta_{pCD} [Deg];#theta_{nFD} [Deg];",
                                                                         numTH2Dbins_Ang_Plots, 10, 80, numTH2Dbins_Ang_Plots, 10, 80);
    std::string hTheta_nFD_vs_theta_pCD_for_Theta_nFD_pCD_10_nFDpCD_Dir = directories.Angle_Directory_map["Opening_angles_nFDpCD_Directory"];
    //</editor-fold>
...
// Neutron veto plots (nFDpCD) ----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    hPlot2D hdTheta_nFD_e_VS_dPhi_nFD_e_Electrons_BV_nFDpCD = hPlot2D("nFDpCD", "FD", "#Delta#theta_{nFD,e} vs. #Delta#phi_{nFD,e} BV",
                                                                      "'Neutron Hits' vs. Electron Hits - Before Veto",
                                                                      "#Delta#phi_{nFD,e} = #phi_{nFD}^{ECIN/ECOUT} - #phi_{e}^{ECAL} [Deg]",
                                                                      "#Delta#theta_{nFD,e} = #theta_{nFD}^{ECIN/ECOUT} - #theta_{e}^{ECAL} [Deg]",
...
// ======================================================================================================================================================================
    ...
    TH1D *hE_e_15_All_Int_pFDpCD_FD = new TH1D("E_{e} around #theta_{e} = 15#circ (All Int., pFDpCD)", "E_{e} around #theta_{e} = 15#circ (All Int., pFDpCD);E_{e} [GeV]",
                                               numTH1Dbins_E_e_Plots, 0, beamE * 1.1);
    TH1D *hE_e_15_QEL_pFDpCD_FD = new TH1D("E_{e} around #theta_{e} = 15#circ (QEL Only, pFDpCD)", "E_{e} around #theta_{e} = 15#circ (QEL Only, pFDpCD);E_{e} [GeV]",
                                           numTH1Dbins_E_e_Plots, 0, beamE * 1.1);
    TH1D *hE_e_15_MEC_pFDpCD_FD = new TH1D("E_{e} around #theta_{e} = 15#circ (MEC Only, pFDpCD)", "E_{e} around #theta_{e} = 15#circ (MEC Only, pFDpCD);E_{e} [GeV]",
                                           numTH1Dbins_E_e_Plots, 0, beamE * 1.1);
    TH1D *hE_e_15_RES_pFDpCD_FD = new TH1D("E_{e} around #theta_{e} = 15#circ (RES Only, pFDpCD)", "E_{e} around #theta_{e} = 15#circ (RES Only, pFDpCD);E_{e} [GeV]",
                                           numTH1Dbins_E_e_Plots, 0, beamE * 1.1);
    TH1D *hE_e_15_DIS_pFDpCD_FD = new TH1D("E_{e} around #theta_{e} = 15#circ (DIS Only, pFDpCD)", "E_{e} around #theta_{e} = 15#circ (DIS Only, pFDpCD);E_{e} [GeV]",
                                           numTH1Dbins_E_e_Plots, 0, beamE * 1.1);
    ...
    TH1D *hE_e_15_All_Int_nFDpCD_FD = new TH1D("E_{e} around #theta_{e} = 15#circ (All Int., nFDpCD)", "E_{e} around #theta_{e} = 15#circ (All Int., nFDpCD);E_{e} [GeV]",
                                               numTH1Dbins_E_e_Plots, 0, beamE * 1.1);
    TH1D *hE_e_15_QEL_nFDpCD_FD = new TH1D("E_{e} around #theta_{e} = 15#circ (QEL Only, nFDpCD)", "E_{e} around #theta_{e} = 15#circ (QEL Only, nFDpCD);E_{e} [GeV]",
                                           numTH1Dbins_E_e_Plots, 0, beamE * 1.1);
    TH1D *hE_e_15_MEC_nFDpCD_FD = new TH1D("E_{e} around #theta_{e} = 15#circ (MEC Only, nFDpCD)", "E_{e} around #theta_{e} = 15#circ (MEC Only, nFDpCD);E_{e} [GeV]",
                                           numTH1Dbins_E_e_Plots, 0, beamE * 1.1);
    TH1D *hE_e_15_RES_nFDpCD_FD = new TH1D("E_{e} around #theta_{e} = 15#circ (RES Only, nFDpCD)", "E_{e} around #theta_{e} = 15#circ (RES Only, nFDpCD);E_{e} [GeV]",
                                           numTH1Dbins_E_e_Plots, 0, beamE * 1.1);
    TH1D *hE_e_15_DIS_nFDpCD_FD = new TH1D("E_{e} around #theta_{e} = 15#circ (DIS Only, nFDpCD)", "E_{e} around #theta_{e} = 15#circ (DIS Only, nFDpCD);E_{e} [GeV]",
                                           numTH1Dbins_E_e_Plots, 0, beamE * 1.1);
