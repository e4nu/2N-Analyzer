...
void histPlotter1D(TCanvas *HistogramCanvas,            // The canvas
                   ...
                   const std::string &Histogram1DSaveNamePath, std::string finalState, int kColor, bool centerTitle, bool AddToStack, bool ShowStats, bool title2, bool apply_plot_cuts,
...
void histPlotter1D(TCanvas *HistogramCanvas,            // The canvas
                   ...
                   bool LinearScalePlot, THStack *Histogram1DStack, std::string Histogram1DSaveName, const std::string &Histogram1DSaveNamePath, std::string finalState, int kColor,
...
void histPlotter1D(TCanvas *HistogramCanvas1,           // canvas c1 of other histograms
                   ...
                   const std::string &Histogram1DSaveNamePath, int kColor, bool centerTitle, bool AddToStack, bool ShowStats, bool title2, bool apply_plot_cuts, double plot_cuts,
...
void histPlotter1D(TCanvas *HistogramCanvas1,           // canvas c1 of other histograms
                   ...
                   const std::string &Histogram1DSaveNamePath, bool centerTitle, bool ShowStats, bool title2, bool apply_plot_cuts, double plot_cuts, double plot_Xmax, bool plot_max) {
    double TitleFontSize = gStyle->GetTitleFontSize();
    HistogramCanvas->cd();
...
void histPlotter1D(TCanvas *HistogramCanvas1,           // canvas c1 of other histograms
                   ...
                   THStack *Histogram1DStack, std::string Histogram1DSaveName, const std::string &Histogram1DSaveNamePath, int kColor, bool centerTitle, bool AddToStack, bool ShowStats,
                   bool title2, bool apply_plot_cuts, double plot_cuts1, double plot_Xmax1, double plot_cuts2, double plot_Xmax2, bool plot_max) {
    double TitleFontSize = gStyle->GetTitleFontSize();
    HistogramCanvas->cd();
...
void histPlotter1D(TCanvas *HistogramCanvas1,           // canvas c1 of other histograms
                   ...
                   std::string Histogram1DTitle1, std::string Histogram1DTitle2, std::string Histogram1DTitle3, std::string Particle1, std::string Particle2, double titleSize,
                   double labelSizex, double labelSizey, TList *Histogram_list, const char *Histogram_OutPDF, int lineWidth, bool LogScalePlot, bool LinearScalePlot,
                   std::string Histogram1DSaveName, const std::string &Histogram1DSaveNamePath, bool centerTitle, bool ShowStats, bool title2, bool apply_plot_cuts, double plot_cuts1,
...
void histPlotter2D(TCanvas *HistogramCanvas, TH2D *Histogram2D, double titleSize, bool centerTitle, double labelSizex, double labelSizey, double labelSizez, TList *Histogram_list,
                   const char *Histogram_OutPDF, bool zLogScalePlot, std::string Histogram1DSaveNameDir, std::string Histogram1DSaveName, bool ShowStats) {
