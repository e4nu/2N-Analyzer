...
class Directories {
   private:
    ...
    std::string ETrans_Parent_Directory = "08_ET_plots";
    ...
    std::string Hit_Maps_Parent_Directory = "13_Acceptance_maps_plots";
   ...
   public:
    map<string, string> Nphe_dir_map;
    map<string, string> Chi2_dir_map;
    map<string, string> Vertex_dir_map;
    map<string, string> SF_dir_map;
    ...
    map<string, string> Momentum_transfer_dir_map;
    map<string, string> E_e_dir_map;
    map<string, string> ETrans_dir_map;
    map<string, string> Ecal_dir_map;
    map<string, string> TKI_dir_map;
    map<string, string> ToF_dir_map;
    map<string, string> Eff_and_ACorr_dir_map;
    map<string, string> AMaps_dir_map;
    map<string, string> Resolution_dir_map;
    map<string, string> Multiplicity_dir_map;
