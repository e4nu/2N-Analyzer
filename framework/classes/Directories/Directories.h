...
class Directories {
   private:
    ...
    std::vector<string> Nphe_Daughter_Folders = {"", "01_1e_cut", "02_1p", "03_1n", "04_2p", "05_pFDpCD", "06_nFDpCD"};
    //</editor-fold>
    ...
    std::vector<string> Chi2_Daughter_Folders = {"", "00_All_e", "01_1e_cut", "02_1p", "03_1n",
    ...
    std::vector<string> Vertex_Daughter_Folders = {"",
    ...
    std::vector<string> SF_Daughter_Folders = {
        "",
        //                                               "01_1e_cut",
    ...
    std::vector<string> fiducial_Daughter_Folders = {"",
                                                //                                                     "01_1e_cut",
                                                "01_1e_cut/01_PCAL",
    ...
    std::vector<string> Momentum_Daughter_Folders = {
    ...
    std::vector<string> W_Daughter_Folders = {"", "01_1e_cut", "02_1p", "03_1n", "04_2p", "05_pFDpCD", "06_nFDpCD"};
    //</editor-fold>

    //<editor-fold desc="Beta plots directories">
    bool create_Beta_Dir = true;
    std::string Beta_Parent_Directory = "03_Beta_plots";
    std::vector<string> Beta_Daughter_Folders = {"", "01_Beta_fit_plots", "01_Beta_fit_plots/03_1n", "01_Beta_fit_plots/03_1n/01_Neutron_beta_from_fPhotons_plots_1n",
    ...
    std::vector<string> Angle_Daughter_Folders = {
        "",
        //                                                  "00_All_e",
        "00_All_e/01_Theta_e_All_e_plots", "00_All_e/02_Phi_e_All_e_plots", "00_All_e/03_Theta_e_VS_Phi_e_All_e_plots",
        //                                                  "00_All_e/03_Theta_neut_VS_Phi_neut_All_e_plots",

        //                                                  "01_1e_cut",
        "01_1e_cut/01_Theta_e_1e_cut_plots", "01_1e_cut/02_Phi_e_1e_cut_plots", "01_1e_cut/03_Theta_e_VS_Phi_e_1e_cut_plots", "01_1e_cut/04_Neutron_veto_1e_cut_plots",

        //                                                  "02_1p",
        "02_1p/01_Theta_e_1p_plots", "02_1p/02_Phi_e_1p_plots", "02_1p/03_Theta_e_VS_Phi_e_1p_plots", "02_1p/04_Theta_p_1p", "02_1p/05_Phi_p_1p", "02_1p/06_Theta_p_VS_Phi_p_1p_plots",
        "02_1p/07_Opening_angles_1p_plots",

        //                                                  "03_1n",
        "03_1n/01_Theta_e_1n_plots", "03_1n/02_Phi_e_1n_plots", "03_1n/03_Theta_e_VS_Phi_e_1n_plots", "03_1n/04_Theta_n_1n", "03_1n/05_Phi_n_1n", "03_1n/06_Theta_n_VS_Phi_n_1n_plots",
        ...
        //                                                  "04_2p",
        "04_2p/01_Theta_e_2p_plots", "04_2p/02_Phi_e_2p_plots", "04_2p/03_Theta_e_VS_Phi_e_2p_plots", "04_2p/04_Opening_angles_2p_plots",
        "04_2p/04_Opening_angles_2p_plots/00_Theta_p1_p2_by_interaction", "04_2p/05_Ghost_tracks_handling_2p_plots", "04_2p/05_Ghost_tracks_handling_2p_plots/01_CFoF_hits_2p_plots",
        "04_2p/05_Ghost_tracks_handling_2p_plots/01_CFoF_hits_2p_plots/00_CFoF_hits_monitoring_2p_plots", "04_2p/05_Ghost_tracks_handling_2p_plots/02_Double_detection_2p_plots",
        "04_2p/05_Ghost_tracks_handling_2p_plots/02_Double_detection_2p_plots/00_Double_detection_monitoring_2p_plots",

        //                                                  "05_pFDpCD",
        "05_pFDpCD/01_Theta_e_pFDpCD_plots", "05_pFDpCD/02_Phi_e_pFDpCD_plots", "05_pFDpCD/03_Theta_e_VS_Phi_e_pFDpCD_plots", "05_pFDpCD/04_Theta_pFD_pFDpCD_plots",
        "05_pFDpCD/05_Phi_pFD_pFDpCD_plots", "05_pFDpCD/06_Theta_pFD_VS_Phi_pFD_pFDpCD_plots", "05_pFDpCD/07_Theta_pCD_pFDpCD_plots", "05_pFDpCD/08_Phi_pCD_pFDpCD_plots",
        "05_pFDpCD/09_Theta_pCD_VS_Phi_pCD_pFDpCD_plots", "05_pFDpCD/10_Theta_tot_pFDpCD_plots", "05_pFDpCD/11_Phi_tot_pFDpCD_plots", "05_pFDpCD/12_Theta_tot_VS_Phi_tot_pFDpCD_plots",
        "05_pFDpCD/13_Theta_rel_pFDpCD_plots", "05_pFDpCD/14_Phi_rel_pFDpCD_plots", "05_pFDpCD/15_Theta_rel_VS_Phi_rel_pFDpCD_plots", "05_pFDpCD/16_Opening_angles_pFDpCD_plots",
        "05_pFDpCD/16_Opening_angles_pFDpCD_plots/00_Theta_pFD_pCD_by_interaction", "05_pFDpCD/17_Ghost_tracks_handling_pFDpCD_plots",
        ...
        //                                                  "06_nFDpCD",
        "06_nFDpCD/01_Theta_e_nFDpCD_plots", "06_nFDpCD/02_Phi_e_nFDpCD_plots", "06_nFDpCD/03_Theta_e_VS_Phi_e_nFDpCD_plots", "06_nFDpCD/04_Theta_nFD_nFDpCD_plots",
        "06_nFDpCD/05_Phi_nFD_nFDpCD_plots", "06_nFDpCD/06_Theta_nFD_VS_Phi_nFD_nFDpCD_plots", "06_nFDpCD/07_Theta_pCD_nFDpCD_plots", "06_nFDpCD/08_Phi_pCD_nFDpCD_plots",
        "06_nFDpCD/09_Theta_pCD_VS_Phi_pCD_nFDpCD_plots", "06_nFDpCD/10_Theta_tot_nFDpCD_plots", "06_nFDpCD/11_Phi_tot_nFDpCD_plots", "06_nFDpCD/12_Theta_tot_VS_Phi_tot_nFDpCD_plots",
        "06_nFDpCD/13_Theta_rel_nFDpCD_plots", "06_nFDpCD/14_Phi_rel_nFDpCD_plots", "06_nFDpCD/15_Theta_rel_VS_Phi_rel_nFDpCD_plots", "06_nFDpCD/16_Opening_angles_nFDpCD_plots",
        "06_nFDpCD/16_Opening_angles_nFDpCD_plots/00_Theta_nFD_pCD_by_interaction", "06_nFDpCD/17_Ghost_tracks_handling_nFDpCD_plots/02_Double_detection_nFDpCD_plots",
        "06_nFDpCD/17_Ghost_tracks_handling_nFDpCD_plots/02_Double_detection_nFDpCD_plots/00_Double_detection_monitoring_nFDpCD_plots", "06_nFDpCD/18_Neutron_veto_nFDpCD_plots",

        //                                                  "07_1e2pXy",
        "07_1e2pXy/01_Theta_e_1e2pXy_plots", "07_1e2pXy/02_Phi_e_1e2pXy_plots", "07_1e2pXy/03_Theta_e_VS_Phi_e_1e2pXy_plots", "07_1e2pXy/04_Phi_Proton_1e2pXy_plots"};
    //</editor-fold>
    ...
    std::vector<string> Momentum_transfer_Daughter_Folders = {"", "00_All_e", "01_1e_cut", "02_1p", "03_1n", "04_2p", "05_pFDpCD", "06_nFDpCD"};
    //</editor-fold>

    //<editor-fold desc="E_e plots directories">
    bool create_E_e_Dir = true;
    std::string E_e_Parent_Directory = "06_E_e_plots";
    std::vector<string> E_e_Daughter_Folders = {"",
                                           "01_1e_cut",
    ...
    std::vector<string> ETrans_Daughter_Folders = {"",
                                              "02_1p",
    ...
    std::vector<string> Ecal_Daughter_Folders = {"",
                                            "02_1p",
    ...
    std::vector<string> TKI_Daughter_Folders = {"",
                                           "03_1n",
                                           "03_1n/01_dP_T_1n",
    ...
    std::vector<string> ToF_Daughter_Folders = {"", "01_1e_cut", "01_1e_cut/01_Neutron_vs_cParticles_hits_FTOF_1e_cut", "06_nFDpCD", "06_nFDpCD/01_Neutron_vs_cParticles_hits_FTOF_nFDpCD"};
    //</editor-fold>
    ...
    std::vector<string> Eff_and_ACorr_Daughter_Folders = {
        "",
        "01_1e_cut",
    ...
    std::vector<string> Hit_Maps_Daughter_Folders = {
        "",
        "01_AMaps_1e_cut",
    ...
    std::vector<string> Resolution_Daughter_Folders = {
        "",
        "02_1p",
    ...
    std::vector<string> Multiplicity_Daughter_Folders = {
    ...
    std::string Find(std::vector<string> vector, std::string string);

   public:
    std::map<string, string> Nphe_Directory_map;
    std::map<string, string> Chi2_Directory_map;
    std::map<string, string> Vertex_Directory_map;
    std::map<string, string> SF_Directory_map;
    std::map<string, string> Fiducial_Directory_map;
    std::map<string, string> Momentum_Directory_map;

    std::map<string, string> W_Directory_map;
    std::map<string, string> Beta_Directory_map;
    std::map<string, string> Angle_Directory_map;
    std::map<string, string> Momentum_transfer_Directory_map;
    std::map<string, string> E_e_Directory_map;
    std::map<string, string> ETrans_Directory_map;
    std::map<string, string> Ecal_Directory_map;
    std::map<string, string> TKI_Directory_map;
    std::map<string, string> ToF_Directory_map;
    std::map<string, string> Eff_and_ACorr_Directory_map;
    std::map<string, string> AMaps_Directory_map;
    std::map<string, string> Resolution_Directory_map;
    std::map<string, string> Multiplicity_Directory_map;
