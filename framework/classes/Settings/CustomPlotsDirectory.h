...
class CustomPlotsDirectory {
   private:
    ...
    // std::string Global_Run_Status = "ChainRunV13_R1_E_miss_in_QEandMECandSRC_theta_q_pCD_test";
    std::string Global_Run_Status = "ChainRunV13_R1_E_miss_in_MECandSRC_test";
    // std::string Global_Run_Status = "ChainRunV13_R1_E_miss_in_MECandSRC_theta_q_pCD_test";
