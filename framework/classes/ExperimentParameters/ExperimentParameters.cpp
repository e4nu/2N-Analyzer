...
#pragma region /* ConfigureBeamEnergy function */
    double ExperimentParameters::ConfigureBeamEnergy(const std::string &sn) {
        ...
        if (basic_tools::FindSubstring(sn, "598636MeV") || basic_tools::FindSubstring(sn, "598636mev") || basic_tools::FindSubstring(sn, "598636") ||
            basic_tools::FindSubstring(sn, "5986MeV") || basic_tools::FindSubstring(sn, "5986mev") || basic_tools::FindSubstring(sn, "5986") || basic_tools::FindSubstring(sn, "6GeV") ||
            basic_tools::FindSubstring(sn, "6Gev") || basic_tools::FindSubstring(sn, "6gev")) {
            be = 5.98636;
                   ...
                   basic_tools::FindSubstring(sn, "4029MeV") || basic_tools::FindSubstring(sn, "4029mev") || basic_tools::FindSubstring(sn, "4029") ||
                   basic_tools::FindSubstring(sn, "4GeV") || basic_tools::FindSubstring(sn, "4Gev") || basic_tools::FindSubstring(sn, "4gev")) {
            be = 4.02962;
                   ...
                   basic_tools::FindSubstring(sn, "2070MeV") || basic_tools::FindSubstring(sn, "2070mev") || basic_tools::FindSubstring(sn, "2070") ||
                   basic_tools::FindSubstring(sn, "2GeV") || basic_tools::FindSubstring(sn, "2Gev") || basic_tools::FindSubstring(sn, "2gev")) {
            be = 2.07052;
        }
...
#pragma region /* Description */
    ...
    void ExperimentParameters::AddToHipoChain(HipoChain & chain, const std::string &sn, const std::string &AnalyzeFilePath, const std::string &AnalyzeFileSample,
