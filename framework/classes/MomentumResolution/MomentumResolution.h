...
class MomentumResolution {
   ...
   public:
    ...
    std::vector<string> Get_Loaded_Smear_coefficients_names() const { return Loaded_Smear_coefficients_names; };
    ...
    std::vector<string> Get_Loaded_Corr_coefficients_names() const { return Loaded_Corr_coefficients_names; };
