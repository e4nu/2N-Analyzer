...
#pragma region /* Vertex plots directories */
    bool create_Vtx_Dir = true;
    std::string Vtx_Parent_Directory = "01_Cuts_plots/01_Preselection_cuts/01_Vtx_plots";
    std::vector<std::string> Vtx_Daughter_Folders = {
        "", "01_1e_cut/01_Electrons", "01_1e_cut/02_Protons", "01_1e_cut/03_Kplus", "01_1e_cut/04_Kminus", "01_1e_cut/05_Piplus", "01_1e_cut/06_Piminus", "01_1e_cut/07_Deuteron"};
#pragma endregion

#pragma region /* Vertex correlation plots directories */
    bool create_Vtx_corr_Dir = true;
    std::string Vtx_corr_Parent_Directory = "01_Cuts_plots/01_Preselection_cuts/02_Vtx_corr_plots";
    std::vector<std::string> Vtx_corr_Daughter_Folders = {"",
                                                          "01_1e_cut/01_Protons",
                                                          "01_1e_cut/02_Kplus",
                                                          "01_1e_cut/03_Kminus",
                                                          "01_1e_cut/04_Piplus",
                                                          "01_1e_cut/05_Piminus",
                                                          "01_1e_cut/06_Deuteron",
                                                          "02_1p",
                                                          "03_1n",
                                                          "04_2p",
                                                          "05_pFDpCD",
...
#pragma region /* DC edge cuts plots directories */
    bool create_DC_edge_Dir = true;
    std::string DC_edge_Parent_Directory = "01_Cuts_plots/01_Preselection_cuts/03_DC_edge_plots";
    std::vector<std::string> DC_edge_Daughter_Folders = {
        "", "01_1e_cut/01_Electrons", "01_1e_cut/02_Protons", "01_1e_cut/03_Kplus", "01_1e_cut/04_Kminus", "01_1e_cut/05_Piplus", "01_1e_cut/06_Piminus", "01_1e_cut/07_Deuteron",
    };
#pragma endregion
...
#pragma region /* Number of Photo-electrons (Nphe) plots directories */
    ...
    std::string Nphe_Parent_Directory = "01_Cuts_plots/02_Electron_quality_cuts/01_Nphe_cuts_plots";
...
#pragma region /* Deposited energy plots directories */
    bool create_Edep_Dir = true;
    std::string Edep_Parent_Directory = "01_Cuts_plots/02_Electron_quality_cuts/02_Edep_cuts_plots";
    std::vector<std::string> Edep_Daughter_Folders = {"", "01_1e_cut"};
#pragma endregion

#pragma region /* Sampling Fraction (SF) plots directories */
    bool create_SF_Dir = true;
    std::string SF_Parent_Directory = "01_Cuts_plots/02_Electron_quality_cuts/03_SF_cuts_plots";
    std::vector<std::string> SF_Daughter_Folders = {
        "",
        "01_1e_cut/01_SF_plots",
        "01_1e_cut/02_SF_VS_P_e_plots",
        "01_1e_cut/03_SF_VS_Edep_PCAL_plots",

        "02_1p/01_SF_plots",
        "02_1p/02_SF_VS_P_e_plots",
        "02_1p/03_SF_VS_Edep_PCAL_plots",

        "03_1n/01_SF_plots",
        "03_1n/02_SF_VS_P_e_plots",
        "03_1n/03_SF_VS_Edep_PCAL_plots",

        "04_2p/01_SF_plots",
        "04_2p/02_SF_VS_P_e_plots",
        "04_2p/03_SF_VS_Edep_PCAL_plots",

        "05_pFDpCD/01_SF_plots",
        "05_pFDpCD/02_SF_VS_P_e_plots",
        "05_pFDpCD/03_SF_VS_Edep_PCAL_plots",

        "06_nFDpCD/01_SF_plots",
        "06_nFDpCD/02_SF_VS_P_e_plots",
        "06_nFDpCD/03_SF_VS_Edep_PCAL_plots",
    };
#pragma endregion

#pragma region /* Edge cuts histograms plots directories */
    bool create_fiducial_Dir = true;
    std::string ECAL_Fiducial_Parent_Directory = "01_Cuts_plots/02_Electron_quality_cuts/04_ECAL_edge_cuts_plots";
...
#pragma region /* Chi2 plots directories */
    ...
    std::string Chi2_Parent_Directory = "01_Cuts_plots/03_Hadron_PID_cuts/01_Chi2_plots";
    std::vector<std::string> Chi2_Daughter_Folders = {"", "00_All_e", "01_1e_cut", "02_1p", "03_1n", "04_2p", "05_pFDpCD", "06_nFDpCD"};
#pragma endregion

#pragma region /* CD proton PID plots directories */
    bool create_pCD_PID_Dir = true;
    std::string pCD_PID_Parent_Directory = "01_Cuts_plots/03_Hadron_PID_cuts/02_pCD_PID_plots";
    std::vector<std::string> pCD_PID_Daughter_Folders = {"", "01_1e_cut"};
#pragma endregion

#pragma region /* CD edge plots directories */
    bool create_CD_edge_Dir = true;
    std::string CD_edge_Parent_Directory = "01_Cuts_plots/03_Hadron_PID_cuts/03_CD_edge_plots";
    std::vector<std::string> CD_edge_Daughter_Folders = {"", "01_1e_cut"};
#pragma endregion
...
#pragma region /* Momentum threshold plots directories */
    ...
    std::string Momentum_Parent_Directory = "01_Cuts_plots/04_Momentum_plots";
...
#pragma region /* Resolution plots directories */
    ...
    std::vector<std::string> Resolution_Daughter_Folders = {"",
                                                            ...
                                                            "03_1n/02_Match_monitoring_plots_1n/01_Before_matching_cuts_1n",
                                                            "03_1n/02_Match_monitoring_plots_1n/02_After_only_dPhi_cuts_1n",
                                                            "03_1n/02_Match_monitoring_plots_1n/03_After_matching_cuts_1n",
                                                            "03_1n/03_Match_multi_plots_1n",
                                                            ...
                                                            "03_1n/05_Resolution_mom_plots_1n",
                                                            "03_1n/06_Resolution_status_plots_1n",
                                                            "03_1n/07_Resolution_vtx_plots_1n",
                                                            "03_1n/08_Resolution_Hcorr_plots_1n",
                                                            "03_1n/09_Resolution_matchedHcorr_plots_1n",
                                                            "03_1n/10_Resolution_ECALcorr_plots_1n",
                                                            "03_1n/11_Resolution_shower_width_plots_1n",
                                                            "03_1n/12_Resolution_shower_moment_plots_1n"};
#pragma endregion
...
#pragma endregion
    ...
    bool FindSubstring(const std::string& string1, const std::string& string2) const;

    std::string Find(const std::vector<std::string>& vector, const std::string& string) const;
    ...
    std::string FindCached(const std::vector<std::string>& vector, const std::string& string) const;

    void SetDirectory(std::map<std::string, std::string>& directory_map, const std::string& map_key, const std::string& base_folder, const std::string& parent_folder,
   ...
   public:
    // Preselection cuts:
    std::map<std::string, std::string> Vtx_dir_map;
    std::map<std::string, std::string> Vtx_corr_dir_map;
    std::map<std::string, std::string> DC_edge_dir_map;

    std::map<std::string, std::string> Nphe_dir_map;
    std::map<std::string, std::string> Edep_dir_map;
    std::map<std::string, std::string> SF_dir_map;
    std::map<std::string, std::string> ECAL_fiducial_dir_map;

    std::map<std::string, std::string> Chi2_dir_map;
    std::map<std::string, std::string> pCD_PID_dir_map;
    std::map<std::string, std::string> CD_edge_dir_map;
    std::map<std::string, std::string> Momentum_dir_map;

    std::map<std::string, std::string> ReacMon_dir_map;
    std::map<std::string, std::string> W_dir_map;
    std::map<std::string, std::string> Beta_dir_map;
    std::map<std::string, std::string> Angle_dir_map;
    std::map<std::string, std::string> Momentum_transfer_dir_map;
    std::map<std::string, std::string> E_e_dir_map;
    std::map<std::string, std::string> Omega_dir_map;
    std::map<std::string, std::string> Ecal_dir_map;
    std::map<std::string, std::string> TKI_dir_map;
    std::map<std::string, std::string> ToF_dir_map;
    std::map<std::string, std::string> Eff_and_ACorr_dir_map;
    std::map<std::string, std::string> AMaps_dir_map;
    std::map<std::string, std::string> Resolution_dir_map;
    std::map<std::string, std::string> Multiplicity_dir_map;
