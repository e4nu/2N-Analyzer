...
// Include libraries:
#include "../../libraries/general_utilities/basic_tools.h"  // My addition!

// Include CLAS12 libraries:
#include "../../CLAS12/clas12_include.h"  // My addition!

// Other includes:
#include "clas12debug.h"  // My addition!
...
namespace bt = basic_tools;  // My addition!
...
#pragma region                                                /* My addition (methods) */
    double getEcalSFUpperCut() const { return SF_max_cut; };  // My addition

    double getEcalSFLowerCut() const { return SF_min_cut; };  // My addition

    double getDCEdgeCuts() const { return dc_edge_cut; };  // My addition

    double getEcalEdgeCuts() const { return ecal_edge_cut; };  // My addition

    void setNpheCuts(bool flag = true) { f_NpheCuts = flag; };  // My addition

    double getNpheCuts() const { return htcc_Nphe_cut; };  // My addition

    double getNeutronMomentumCut() const { return Neutron_Momentum_cut; };  // My addition

    double getNeutralBetaCut() const { return FD_Neutral_Beta_cut; };  // My addition

    double getNeutralBetaCutMean() const { return FD_Neutral_Beta_Mean; };  // My addition

    double getdPhiCutMean() const {
...
#pragma endregion
   ...
   private:
    ...
    // My edit - all flags were set to false! (My edits!)
