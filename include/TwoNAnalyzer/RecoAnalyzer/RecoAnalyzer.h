...
// Include libraries:
#include "../../libraries/fitters/fitter_functions.h"
#include "../../libraries/general_utilities/utilities.h"
#include "../../libraries/plotters/draw_and_save_functions/draw_and_save_functions.h"
...
class RecoAnalyzer : protected RecoAnalyzerPrinter {
   public:
    ...
    RecoAnalyzer(const std::string& RecoSamplePath, const std::string& ReconHipoDir, const std::string& InputHipoFiles, const rcli::RecoCliOptions& cli);
   ...
   private:
    void UpdateSettingsFromCLI(const rcli::RecoCliOptions& cli);
    ...
    HistogramSettings HSettings;
    HistogramDefinitionSettings HDefSettings;
