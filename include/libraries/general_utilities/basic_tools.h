...
#include <TString.h>  // include environment for colored output
#include <limits.h>
#include <netdb.h>
...
#pragma region /* TrimWhitespace function */
inline std::string TrimWhitespace(std::string value);
#pragma endregion

// NormalizeFilePathForPrint function -----------------------------------------------------------------------------------------------------------------------------------

#pragma region /* NormalizeFilePathForPrint function */
/**
...
#pragma region /* PrintLine function */
/**
 ...
 */
inline void PrintLine(std::ostream& os, const char fill = '-', const int width = 100) {
...
#pragma region /* PrintLineColored function */
/**
 ...
 */
inline void PrintLineColored(const char fill = '-', const int width = 100, const std::string& color = env::SYSTEM_COLOR, std::ostream& os = std::cout) {
...
#pragma region /* PrintTitleBlock function */
/**
 ...
 */
inline void PrintTitleBlock(const std::string& title, const char fill = '=', const int width = 100, const std::string& color = env::SYSTEM_COLOR, std::ostream& os = std::cout) {
...
#pragma region /* PrintSectionHeader function */
/**
 ...
 */
inline void PrintSectionHeader(const std::string& section, const int width = 100, const std::string& color = env::SYSTEM_COLOR, std::ostream& os = std::cout) {
...
#pragma region /* PrintBanner function */
/**
 ...
 */
inline void PrintBanner(const std::string& label, const int width = 100, const char borderChar = '/', const std::string& borderColor = env::WARNING_COLOR,
...
#pragma region /* PrintAlignedValue function */
/**
 ...
 */
template <typename T>
inline void PrintAlignedValue(std::ostream& os, const std::string& label, const T& value, const int lineWidth = 100, const int minGap = 1) {
...
// PrintAlignedValueToFile function -------------------------------------------------------------------------------------------------------------------------------------

#pragma region /* PrintAlignedValueToFile function */
/**
 * @brief Print a `label: value` pair with right-aligned value placement.
 *
 * @tparam T Printable value type.
 ...
 */
template <typename T>
inline void PrintAlignedValueToFile(std::ostream& os, const std::string& label, const T& value, const int lineWidth = 100, const int minGap = 1) {
    std::ostringstream valueStream;  // Stream for value serialization
    valueStream << value;
    const std::string valueStr = valueStream.str();  // Extract value as string
    const std::string prefix = label + ":";          // Build label prefix
    ...
    os << prefix << std::string(spaces, ' ') << valueStr << "\n";  // Print aligned value
}
#pragma endregion

// PrintAlignedValueColored function ------------------------------------------------------------------------------------------------------------------------------------

#pragma region /* PrintAlignedValueColored function */
/**
 ...
 */
template <typename T>
inline void PrintAlignedValueColored(const std::string& label, const T& value, const int lineWidth = 100, const int minGap = 1, const std::string& color = env::SYSTEM_COLOR,
...
#pragma region /* PrintWrappedLabelValue function */
/**
 ...
 */
template <typename T>
inline void PrintWrappedLabelValue(std::ostream& os, const std::string& label, const T& value, const int lineWidth = 100, const int spacing = 1) {
    std::ostringstream valueStream;  // Serialize value to a stream
    valueStream << value;
    const std::string valueStr = valueStream.str();             // Extract value string
    const std::string prefix = label + ":" + env::RESET_COLOR;  // Build label prefix
    ...
    while (pos < valueStr.size()) {
        ...
        if (firstLine) {
            os << prefix << std::string(spacing, ' ') << chunk << "\n";  // Print first line
            firstLine = false;
        } else {
            os << continuationPrefix << chunk << "\n";  // Print wrapped continuation line
        }
...
#pragma region /* PrintWrappedLabelValueColored function */
/**
 ...
 */
template <typename T>
inline void PrintWrappedLabelValueColored(const std::string& label, const T& value, const int lineWidth = 100, const int spacing = 1, const std::string& color = env::SYSTEM_COLOR,
                                          std::ostream& os = std::cout) {
    os << color;                                                   // Set color
...
#pragma region /* PrintMessage function */
/**
 ...
 */
inline void PrintMessage(const std::string& Message, const bool& MessageSpacing = true) {
    std::cout << env::SYSTEM_COLOR                // Start printing
              << (MessageSpacing ? "\n" : "")     // Optional spacing before massage
              << Message << "\n"                  // Massage to print
              << (MessageSpacing ? "\n" : "")     // Optional spacing after massage
              << env::RESET_COLOR << std::flush;  // End printing
}
#pragma endregion
...
#pragma region /* PrintMessage function */
inline void PrintMessage(const std::string& className, const std::string& functionName, const std::string& Message, const bool& MessageSpacing = true) {
    std::cout << env::SYSTEM_COLOR                                 // Start printing
              << (MessageSpacing ? "\n" : "")                      // Optional spacing before massage
              << "[" << className << "::" << functionName << "] "  // Print [className::functionName]
              << Message << "\n"                                   // Massage to print
              << (MessageSpacing ? "\n" : "")                      // Optional spacing after massage
              << env::RESET_COLOR << std::flush;                   // End printing
}
...
#pragma region /* ExitWithError function */
/**
...
#pragma region /* PrintWarning function */
/**
...
#pragma region /* QuoteForShell function */
/**
 ...
 */
std::string RunShellCommand(const std::string& command, const bool suppress_stderr = true);
#pragma endregion

// GitHubRepoUrlFromRemote function -------------------------------------------------------------------------------------------------------------------------------------

#pragma region /* GitHubRepoUrlFromRemote function */
/**
...
#pragma region /* BoolToChar function */
/**
...
#pragma region /* BoolToString function */
/**
...
#pragma region /* ToStringWithPrecision function */
/**
...
#pragma region /* ReplaceSubstring function */
/**
...
#pragma region /* splitVarAndUnits function */
/**
...
#pragma region /* GetBeamEnergyFromString function */
/**
...
#pragma region /* GetBeamEnergyFromDouble function */
/**
...
#pragma region /* fileExists function */
/**
