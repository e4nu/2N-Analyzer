...
struct RunParameters {
    ...
    RunParameters(const ExperimentParameters& Experiment, const std::string& RecoSamplePath, const std::string& ReconHipoDir)
        : SampleName(Experiment.GetSampleName()),                // Get SampleName from ExperimentParameters (configured from RecoSamplePath and ReconHipoDir)
          ...
          beamE(Experiment.GetBeamEnergyValue()),                // Configure numeric beam energy from SampleName
