...
#ifndef CLAS12DASETTINGS_H
#define CLAS12DASETTINGS_H
...
// ======================================================================================================================================================================
    ...
    ExperimentParameters Experiment(AnalyseFilePath, AnalyseFileSample);
     ...
     bool isData = Experiment.DSample();
     bool is2GeVSample = Experiment.IsBeamAt2GeV();
     bool is4GeVSample = Experiment.IsBeamAt4GeV();
     bool is6GeVSample = Experiment.IsBeamAt6GeV();
    //</editor-fold>
...
//    if (Generate_AMaps) { Rec_wTL_ES = false; }
    ...
    cout << "apply_Nphe_cut:\t\t\t" <<
    BoolToString(apply_Nphe_cut)
    << "\n";
    cout << "apply_chi2_cuts_1e_cut:\t\t" <<
    BoolToString(apply_chi2_cuts_1e_cut)
    << "\n";
    cout << "apply_Vz_cuts:\t\t\t" <<
    BoolToString(apply_Vz_cuts)
    << "\n";
    cout << "apply_dVz_cuts:\t\t\t" <<
    BoolToString(apply_dVz_cuts)
    << "\n";
    cout << "apply_ECAL_SF_cuts:\t\t" <<
    BoolToString(apply_ECAL_SF_cuts)
    << "\n";
    cout << "apply_ECAL_P_cuts:\t\t" <<
    BoolToString(apply_ECAL_P_cuts)
    << "\n";
    cout << "apply_ECAL_fiducial_cuts:\t" <<
    BoolToString(apply_ECAL_fiducial_cuts)
    << "\n";
    cout << "apply_DC_fiducial_cuts:\t\t" <<
    BoolToString(apply_DC_fiducial_cuts)
    << "\n";
    cout << "apply_nucleon_cuts:\t\t" <<
    BoolToString(apply_nucleon_cuts)
    << "\n";
    cout << "apply_nucleon_physical_cuts:\t" <<
    BoolToString(apply_nucleon_physical_cuts)
    << "\n";
    cout << "apply_nBeta_fit_cuts:\t\t" <<
    BoolToString(apply_nBeta_fit_cuts)
    << "\n";
    cout << "apply_fiducial_cuts:\t\t" <<
    BoolToString(apply_fiducial_cuts)
    << "\n";
    cout << "apply_kinematical_cuts:\t\t" <<
    BoolToString(apply_kinematical_cuts)
    << "\n";
...
// Delete setup ------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    delete_png_files &&delete_root_files
    ) {
...
// Debugging setup ---------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    SetGPMonitoringPlots(GoodProtonsMonitorPlots, directories
